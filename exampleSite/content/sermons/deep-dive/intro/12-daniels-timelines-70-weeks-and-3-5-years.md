---
title: "Background: Daniel's Timelines: 70 Weeks and 3½ Years"
weight: 12
docType: sermon
...
## A Note for Group Leaders Before You Start

This is the densest session in the introduction, covering two distinct but related time schemes
(Daniel's 70 "weeks" and Revelation's parallel 3.5-year expressions). If your group tends to meet
weekly without the constraint of a single Sunday service, consider splitting this into two
sessions — Part 1 on the 70 weeks, Part 2 on the 3.5 years — rather than rushing through both in
one sitting. What follows is written as one complete session, but the natural break point is
marked clearly below.

## Opening Hook

Ask your group: has anyone tried to build a timeline chart of end-times events from Daniel and
...
kept. When exile came, it lasted 70 years — one year for every missed Sabbatical year
({{% bible val="2 Chronicles 36:20-21" link="2ch:36,20-21" lang="en" %}}), which means 70 missed
Sabbaticals span 7×70=490 years, roughly the whole span of Israel's national existence to that
point. That's why a "week" in Daniel means seven years, not seven days — deliberately echoing
the Sabbath pattern.

**The prayer and its answer.** Daniel, aware of Jeremiah's 70-year promise
({{% bible val="Jeremiah 29:10" link="jer:29,10" lang="en" %}}), prays for his people
({{% bible val="Daniel 9:3-19" link="dan:9,3-19" lang="en" %}}) and receives an answer covering
"seventy sevens" — 490 years — decreed to finish transgression, end sin, atone for wickedness,
...
and half a time" = 3.5 years. Five separate references
({{% bible val="Rev 11:2" link="rev:11,2" lang="en" %}},
{{% bible val="11:3" link="rev:11,3" lang="en" %}},
{{% bible val="12:6" link="rev:12,6" lang="en" %}},
{{% bible val="12:14" link="rev:12,14" lang="en" %}},
{{% bible val="13:5" link="rev:13,5" lang="en" %}}) all point to this same underlying period.

**Original-language and background note: Elijah's drought.** Elijah announces a drought against
Jezebel's Baal worship that lasts, per Jesus's own reference to it,
{{% bible val="3.5 years" link="luk:4,25" lang="en" %}} — even though 1 Kings itself never states
the exact duration. The whole episode turns on one question: who is the true God, the one who
sends rain and fire from heaven? Notably, the second beast in Revelation 13 performs that exact
same feat — {{% bible val="calling down fire" link="rev:13,13" lang="en" %}} — a deliberate,
unsettling echo of Elijah's Mount Carmel test, this time performed by a counterfeit.
...
return. The woman (representing God's people) is protected in the wilderness for the same span.
The temple's outer court, no longer used for sacrifice, is trampled by the nations for the same
period — again running from the cross to the second coming. That leaves the two witnesses'
1260 days, which likewise span the whole age between Christ's two comings — a real clue, given
how long that is, that "the witnesses" function much more plausibly as the church itself than as
...
**So what for us:**
4. Daniel's precise, sober arithmetic converges on the cross rather than a random future date.
   How does that reshape your instinct to look for coded predictions of near-future events in
   these same numbers?
5. The "1260 days" almost certainly describes the whole church age, not a short future
   tribulation period. If the church has already been living out its "1260 days" of witness for
...
Thank God for the staggering precision of a prophecy written centuries in advance that converges
on the cross itself. Ask for the wisdom to hold Scripture's genuinely mysterious details with
humility, without needing to force every number into a tidy chart before you can trust the God
who gave it.

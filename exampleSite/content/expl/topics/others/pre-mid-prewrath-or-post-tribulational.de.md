---
title: "Prätribulational, midtribulational, vor dem Zorn, oder posttribulational?"
themes: ["Entrückung"]
weight: 4
...
- Beschreibt {{% bible val="1. Thessalonicher 4" link="1th:4,13-18" lang="de" %}} ein separates, geheimes Ereignis, oder {{% int_link val="eine einzige, öffentliche Wiedervereinigung mit einem wiederkommenden Christus" link="/expl/topics/others/the-rapture" %}}?
- Ist {{% bible val="Gottes Zorn" link="1th:5,9" lang="de" %}} dasselbe wie Trübsal und Verfolgung durch Menschenhand, oder unterscheidet der Text zwischen beidem?
- Bezeichnet {{% int_link val="die Große Trübsal" link="/expl/content/army/the-end-time-and-the-great-tribulation" %}} überhaupt eine künftige siebenjährige (oder dreieinhalbjährige) Periode, oder die gesamte Spanne der Geschichte zwischen Christi erstem und zweitem Kommen?
- Wenn Gläubige in der ganzen Offenbarung als solche dargestellt werden, die {{% bible val="den Krieg des Tieres gegen die Heiligen" link="rev:13,7" lang="de" %}} erdulden, was würde es dann bedeuten, wenn eine künftige Generation von Gläubigen entfernt würde, bevor das geschieht?

## Prätribulational

<a name="pt1a"></a>
Die Gemeinde wird von der Erde entfernt, bevor irgendein Teil einer künftigen siebenjährigen Trübsalszeit beginnt, in einem geheimen, jederzeit möglichen Ereignis, das sich von Christi sichtbarem zweiten Kommen unterscheidet, welches der Trübsal ganz am Ende folgt. Dies ist die Version, die aus populären Romanen und Filmen am geläufigsten ist, und diejenige, die {{% int_link val="der Dispensationalismus im 19. Jahrhundert einführte" link="/expl/topics/others/dispensionalism-a-little-history" %}}.
...
<a name="mt2b"></a>
Die Entrückung geschieht in der Mitte der sieben Jahre, verbunden mit {{% bible val="der siebten Posaune" link="rev:11,15" lang="de" %}} und {{% bible val="'der letzten Posaune'" link="1co:15,52" lang="de" %}}, sodass die Gemeinde die erste, mildere Hälfte durchsteht — die Verfolgung durch das Tier —, aber vor der zweiten Hälfte entfernt wird, wenn Gottes eigener Zorn in den Schalen ausgegossen wird.
...
<a name="pw3c"></a>
Die Entrückung geschieht noch später — nach der Verfolgung der Heiligen durch das Tier, aber kurz bevor Gottes eigenes Gericht hereinbricht, ungefähr bei {{% bible val="dem sechsten Siegel" link="rev:6,12-17" lang="de" %}}, wo verkündet wird: {{% bible val="'der große Tag ihres Zorns ist gekommen'" link="rev:6,17" lang="de" %}}. Der entscheidende Zug ist die Unterscheidung zwischen Trübsal (Leiden durch menschliche und satanische Hand, wovon Gläubigen keine Befreiung verheißen ist) und Zorn (Gottes eigenem Gericht, wovon sie es sind).

**Dafür spricht:**

- Sie nimmt ernst, dass {{% int_link val="das Neue Testament von Gläubigen erwartet, wirkliche Trübsal zu erleiden" link="/expl/content/army/the-end-time-and-the-great-tribulation" %}}, statt ihr zu entkommen — ein Punkt, den die prätribulationale und midtribulationale Sicht schwerer wegerklären müssen.
- Die Unterscheidung Trübsal/Zorn hat echten Textbezug: {{% bible val="der Krieg des Tieres gegen die Heiligen" link="rev:13,7" lang="de" %}} liest sich anders als {{% bible val="die Schalen, die ausdrücklich 'der Zorn Gottes' genannt werden" link="rev:15,1" lang="de" %}}.
...
- Sie liest die Siegel, Posaunen und Schalen weiterhin als einen einzigen, strengen, sequentiellen Fahrplan statt als {{% int_link val="eine chiastische Struktur, die dieselben Ereignisse aus verschiedenen Blickwinkeln erneut aufgreift" link="/expl/content/1000y/the-thousand-year-kingdom" %}} — was es untergraben würde, ihre Reihenfolge zu nutzen, um den genauen Zeitpunkt einer Entrückung festzulegen.
...
- Wie die anderen futuristischen Zeitpositionen hängt sie davon ab, dass Daniels siebzigste Jahrwoche eine wörtliche künftige Siebenjahresperiode bezeichnet — eine Lesart, gegen die {{% int_link val="die eigene Besprechung der Großen Trübsal auf dieser Seite" link="/expl/content/army/the-end-time-and-the-great-tribulation" %}} direkt argumentiert.

## Posttribulational

<a name="pot4d"></a>
Es gibt überhaupt kein gesondertes Entrückungsereignis, weder geheim noch anders. Gläubige werden versammelt, um dem wiederkommenden Christus ganz am Ende der Geschichte zu begegnen, im selben Moment, in dem er für alle sichtbar wird, und kehren sofort mit ihm zur Erde zurück, die er erneuern will — ein Ereignis, nicht zwei. Dies ist die Lesart, auf die {{% int_link val="der vorherige Artikel" link="/expl/topics/others/the-rapture" %}} ausführlich hinarbeitet.
...
<a name="s5e6"></a>
Von den vieren passt der Posttribulationismus am ehesten zu dem Fall, den {{% int_link val="der vorherige Artikel" link="/expl/topics/others/the-rapture" %}} bereits vertritt: eine sichtbare Wiederkunft, eine Versammlung, Christi Bewegungsrichtung abwärts statt der Bewegungsrichtung der Gemeinde aufwärts. Aber diese Seite geht noch einen Schritt weiter als die meisten Posttribulationisten. Alle vier oben genannten Sichten teilen eine Annahme, die diese Seite nicht teilt: dass {{% int_link val="Daniels siebzigste Jahrwoche eine wörtliche, noch künftige Siebenjahresperiode bezeichnet" link="/expl/content/army/the-end-time-and-the-great-tribulation" %}}, gegen die man eine Entrückung überhaupt erst zeitlich verorten könnte. Wenn die Große Trübsal stattdessen die gesamte Spanne zwischen Christi erstem und zweitem Kommen bezeichnet — die Lesart, für die andernorts auf dieser Seite argumentiert wird —, dann beantwortet die gesamte Prä-/Mid-/Vor-dem-Zorn-/Post-Debatte eine Frage, die auf einer Prämisse aufbaut, die es wert ist, neu aufgerollt zu werden, statt nur eine Entrückung innerhalb eines bereits vorausgesetzten Fahrplans neu zu verorten.

Das ist eine andere Frage als die {{% int_link val="Millenniumsdebatte" link="/expl/content/1000y/pre-post-and-amillennialism" %}}, auch wenn beide in der Praxis oft zusammen auftreten — dispensationalistische Prämillennialisten sind meist prätribulational, historische Prämillennialisten meist posttribulational —, und es lohnt sich, die beiden Fragen im eigenen Denken getrennt zu halten, statt anzunehmen, die eine würde die andere klären.

Ein paar abschließende Fragen, bei denen es sich lohnt zu verweilen:

- Wenn {{% bible val="Offenbarung 3,10" link="rev:3,10" lang="de" %}} keine Entfernung von der Prüfung verspricht, was verspricht der Vers dann stattdessen — und woran würdest du den Unterschied erkennen, mitten in einer echten Prüfung?
...
- {{% int_link val="Bock, Three Views on the Millennium and Beyond" link="/about/ressources/index.html#bock_millennium" %}} zeigt, wie man Positionen fair vergleicht, indem man jede von einem Gelehrten hört, der sie tatsächlich vertritt — {{% int_link val="ein vergleichbarer Band existiert für die Debatte um den Zeitpunkt der Entrückung" link="/about/ressources/index.html#rapture_views" %}}, falls du tiefer gehen willst als eine solche Zusammenfassung.

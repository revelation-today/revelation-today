...
- {{% int_link val="Bock, Three Views on the Millennium and Beyond" link="/about/ressources#bock_millennium" %}} zeigt, wie man Positionen fair vergleicht, indem man jede von einem Gelehrten hört, der sie tatsächlich vertritt — {{% int_link val="ein vergleichbarer Band existiert für die Debatte um den Zeitpunkt der Entrückung" link="/about/ressources#rapture_views" %}}, falls du tiefer gehen willst als eine solche Zusammenfassung.

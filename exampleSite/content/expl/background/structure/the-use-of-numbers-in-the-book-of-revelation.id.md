...
<a name="84db"></a>
Angka tujuh adalah salah satu simbol yang paling sering muncul dalam Alkitab.

Tujuh melambangkan kelengkapan, berakar pada tujuh hari penciptaan.

Murka Allah yang tujuh kali lipat dalam {{% bible val="kisah Kain" link="gen:4,15" lang="ind" %}} dan dalam {{% bible val="Mazmur" link="psa:79,12" lang="ind" %}} dapat dibaca secara kiasan dengan cara yang sama.
...
Ketujuh meterai, ketujuh sangkakala, dan ketujuh cawan murka memperluas pola yang sama ini, menandai kelengkapan penghakiman Allah.
...
Ungkapan "{{% bible val="guruh dan kilat" link="exo:19,16-18" lang="ind" %}}," yang mengingatkan pada Sinai, muncul empat kali pada titik-titik balik yang menentukan:

- {{% bible val="pengantar" link="rev:4,5" lang="ind" %}},
- {{% bible val="penutup meterai-meterai" link="rev:8,5" lang="ind" %}},
- {{% bible val="penutup sangkakala-sangkakala" link="rev:11,19" lang="ind" %}}, dan
- {{% bible val="penutup cawan-cawan murka" link="rev:16,18" lang="ind" %}}.

## Kombinasi 4x7

<a name="1ee7"></a>
Jika {{% bible val="ketujuh guruh" link="rev:10,3-7" lang="ind" %}} dihitung sebagai satu rangkaian penghakiman lagi — atau jika surat-surat kepada jemaat dibaca sebagai memiliki karakter penghakimannya sendiri — maka kitab ini memuat total 4x7 penghakiman yang berkaitan dengan penghakiman atas seluruh dunia, menggemakan {{% bible val="hukum Taurat, di mana penghakiman tujuh kali lipat itu sendiri diulang empat kali" link="lev:26,14-46" lang="ind" %}}.

{{% bible val="Penyebutan sabit sebanyak tujuh kali" link="rev:14,14-19" lang="ind" %}} menunjuk pada kelengkapan penghakiman dunia yang sama.
...
<a name="8d23"></a>
Frekuensi kata-kata memperkuat pola-pola yang sama ini di sepanjang kitab:

- Kata ["perempuan" (*gyne*) muncul 10 kali](https://biblehub.com/greek/strongs_1135.htm), "mempelai" [3 kali](https://biblehub.com/greek/3565.htm), dan "orang-orang kudus" [14 kali](https://biblehub.com/greek/40.htm) — setiap ungkapan menunjuk kepada umat Allah.
- Sebaliknya, [komunitas tandingan "sundal" muncul 4 kali](https://biblehub.com/greek/4204.htm), "perempuan" (merujuk kepadanya) [7 kali](https://biblehub.com/greek/1135.htm), dan [mereka yang diam di bumi 10 kali](https://biblehub.com/greek/3625.htm).
- "Babel" dan "besar" masing-masing disebutkan 6 kali, dan "perempuan" digunakan 6 kali khusus untuk sundal Babel. Enam berfungsi sebagai angka manusia, berlawanan dengan Allah, sebab manusia diciptakan pada hari keenam.

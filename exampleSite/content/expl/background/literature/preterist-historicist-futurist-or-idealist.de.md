---
title: "Präterismus, Historismus, Futurismus oder Idealismus?"
weight: 25
...
- {{% bible val="Der neue Himmel und die neue Erde" link="rev:21,1" lang="de" %}} und {{% bible val="das letzte Gericht vor dem großen weißen Thron" link="rev:20,11-15" lang="de" %}} sind bei jeder vernünftigen Lesart eindeutig noch nicht geschehen — genau deshalb bleibt die überzeugende Form dieser Sichtweise „partiell" und hört deutlich vor Kapitel 20 auf.
- Sie neigt dazu, für Symbole, die der Rest des Buches als wiederkehrend behandelt, einen einzigen Bezugspunkt im ersten Jahrhundert zu bestimmen — {{% int_link val="der Dualismus, den der frühere Artikel zur Gattung des Buches hervorhebt" link="/expl/background/literature/the-book-of-revelation-how-to-read-it" %}}, sollte in jeder Generation zu einer Entscheidung herausfordern, nicht nur ein abgeschlossenes Kapitel der Geschichte beschreiben.
...
- Das Buch auf einen einzigen Krieg zu reduzieren, so erschütternd er für seine ersten Leser auch war, kann dem eigenen Anspruch der Offenbarung nicht gerecht werden, zu {{% bible val="jedem Stamm, jeder Sprache, jedem Volk und jeder Nation" link="rev:7,9" lang="de" %}} zu sprechen, nicht nur zu denen, die den Fall Jerusalems oder die Verfolgung durch Rom miterlebten.

## Historistisch

<a name="h2b3"></a>
Die Offenbarung zeichnet die gesamte Spanne der Kirchengeschichte nach, von Johannes' eigener Zeit bis zur Wiederkunft, Symbol für Symbol — die Siegel, Posaunen und Schalen entsprechen einer Abfolge realer historischer Ereignisse: Völkerwanderungen, der Aufstieg des Islam, das Papsttum, die Reformation und so weiter. Dies war die vorherrschende Lesart unter den Reformatoren, von denen viele das Tier oder die Hure mit dem Papsttum ihrer eigenen Zeit identifizierten — ein Beispiel unter {{% int_link val="der langen Reihe ähnlicher Identifikationen, die an anderer Stelle auf dieser Seite nachgezeichnet wird" link="/expl/topics/others/dispensionalism-a-little-history" %}}, angefangen bei Joachim von Fiores Schema aus dem zwölften Jahrhundert.
...
<a name="f3c4"></a>
Der größte Teil der Offenbarung, ab Kapitel 4 oder 6, beschreibt Ereignisse, die noch vor uns liegen — eine letzte Zeit der Trübsal, ein persönlicher Antichrist und die sichtbare Wiederkunft Christi —, unabhängig davon, wie weit diese Zeit tatsächlich entfernt ist. Das deckt echten Boden ab: Der dispensationalistische Futurismus, {{% int_link val="an anderer Stelle auf dieser Seite ausführlich behandelt" link="/expl/topics/others/dispensionalism-and-its-critic" %}}, ist nur eine Spielart. Nicht-dispensationalistische Futuristen — darunter viele historische Prämillennialisten — erwarten eine reale zukünftige Trübsal und einen realen Antichristen, ohne die Entrückung oder die separate Zukunft für das ethnische Israel, die der Dispensationalismus hinzufügt.
...
- Zu weit getrieben, kann es das Buch in eine verschlüsselte Zeitungsprognose verwandeln, statt in den Brief, die Prophetie und die Apokalypse, als die {{% int_link val="es sich selbst tatsächlich vorstellt" link="/expl/background/literature/the-book-of-revelation-how-to-read-it" %}} — wodurch es den sieben Gemeinden, für die es eigentlich geschrieben wurde, nichts mehr zu sagen hätte.
- {{% bible val="Der Tempel, den Johannes vermessen soll" link="rev:11,1-2" lang="de" %}}, beschreibt am natürlichsten ein Gebäude, das zu seiner eigenen Zeit noch stand — was für Lesarten unbequem ist, die das umliegende Material vollständig in unsere Zukunft verschieben.
...
- Die dispensationalistische Spielart bringt ihre eigenen spezifischen Probleme mit sich, {{% int_link val="in einem eigenen Artikel behandelt" link="/expl/topics/others/dispensionalism-and-its-critic" %}}, auch wenn der nicht-dispensationalistische Futurismus die meisten davon vermeidet.
...
<a name="e5f6"></a>
Statt sich für eine der vier Sichtweisen zu entscheiden, liest diese Seite die Offenbarung so, dass sie alle vier zugleich tut, denn {{% int_link val="die dreifache Gattung des Buches" link="/expl/background/literature/the-book-of-revelation-how-to-read-it" %}} zieht genau in diese Richtungen: Als *Brief* hat sie reale Bezugspunkte im ersten Jahrhundert (präteristisch); als *Apokalypse* zeichnet sie einen zeitlosen Konflikt, der sich in jeder Epoche wiederholt (idealistisch); als *Prophetie* erwartet sie reale, noch ausstehende Konsequenzen (futuristisch) — und da diese Konsequenzen sich über die Geschichte hinweg wiederholen, statt alle auf einmal einzutreffen, hat auch die Intuition des Historismus recht, dass das Buch ein sich entfaltendes Muster beschreibt, kein einzelnes Ereignis, selbst wenn seine konkreten Identifikationen es meist nicht sind. Genau zu dieser Schlussfolgerung kommt {{% int_link val="der frühere Artikel über Symbol und Wörtlichkeit" link="/expl/background/literature/literally-or-symbolic" %}} von einem anderen Blickwinkel aus: dass die Bilder der Offenbarung „historische Vorbilder [sind, die] zu symbolischen Mustern geformt [werden], die sich wiederholen sollen".

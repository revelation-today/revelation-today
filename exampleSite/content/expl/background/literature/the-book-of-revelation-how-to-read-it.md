...
If we say that the majority of this book refers to events that are only applicable in the future (even from our time), we have not considered the aspect that the book is a letter.
...
The prophetic literature in the Old Testament was based on the covenant at Mount Sinai. There God did not just give people a list of rules to follow, but gave them a way of thinking. He said that:
...
When the people did not follow these concepts, the prophets were obliged to reprimand them. Their message was:

- God gave you the law and look - you have broken it (mostly by following idols, resulting in injustice to the poor).
- therefore God will judge you (future aspect) as {{% bible val="described in the law" link="lev:26" lang="en" %}}. The intention is to train the people of God (see the {{% bible val="repeated term" link="lev:26,21" lang="en" %}} in different variants "if you still do not do". In this case God will increase the pressure to see if Israel changes now their behaviour.).
- {{% bible val="He will have mercy on you" link="lev:26,44" lang="en" %}} especially {{% bible val="when you learn your lesson" link="lev:26,40-42" lang="en" %}}.
...
- warns the people to get out of Babel, {{% bible val="don’t let your love grow cold" link="rev:2,4" lang="en" %}}, {{% bible val="don’t allow false teaching" link="rev:2,14-15" lang="en" %}}, etc.
...
The goal of a prophecy is to change behavior and it often uses vivid picture to draw a response from the reader or listener.

But there is another perspective. The intention of prophecy is sometimes to not come true. This sounds a bit surprising, but it becomes clear in the book {{% bible val="Jonah" link="jon:4" lang="en" %}} when Jonah refuses to prophesy against the enemies of Israel (Nineveh was the outpost of the Assyrians) because they might repent and then God's judgment would not come to pass. And that is what happened.

Revelation prophecy is not like the standard Old Testament prophecy, as visions are often introduced with a simple “and I saw”, whereas in the Old Testament they are introduced {{% bible val="more elaborately" link="zec:1,7" lang="en" %}}.

## An apocalypse {#apocalypse}

<a name="apocalypse"></a>
That is the first word of the book: "Apokalypsis Iesou Christou" which is translated as "Revelation of Jesus Christ". While the word "apokalypsis" literally means “revelation”, the direct translation is misleading because this is not a secret foretelling about some event in the far or near future. It is also not about the end of the world, but about the end of the evil rulers and society. The only other apocalyptic texts in the Bible are only in {{% bible val="Daniel 7-12" link="dan:7" lang="en" %}}; {{% bible val="Mark 13" link="mrk:13" lang="en" %}}; {{% bible val="Matthew 24" link="mat:24" lang="en" %}} and {{% bible val="Luke 21" link="luk:21" lang="en" %}} and these are also difficult to understand.
...
- The book has no room for compromise and is full of "either ... ors" (e.g. Lamb vs. Dragon, Jerusalem vs. Babel, the seal of God vs. the mark of the Beast, worshippers of God vs. worshippers of the Beast) that challenge the political order and its ideology. Note that not the emperor but Jesus is the true king, not the Roman peace but the Kingdom of God is the goal, not loyalty to the emperor but faith in Jesus is needed.
...
- a letter, that neeed to make sense to people in the first and second centuries.
- a prophecy: it should encourage people to act differently, not in the future, but in the here and now, by means of giving strong emotional material.
- an apocalypse: it forces God's people to avoid compromise and to oppose wrong rulers by describing an “either … or” world.

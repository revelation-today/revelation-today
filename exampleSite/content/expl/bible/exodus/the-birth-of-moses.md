...
It only takes two chapters of the Bible to tell, and both are worth reading in advance: first {{% bible val="the story of keeping the Israelites" link="exo:1" lang="en" %}} small to avoid a second {{% int_link val="Hyksos" link="/expl/bible/exodus/the-story-before-the-exodus" %}}, and then the {{% bible val="story of Moses" link="exo:2" lang="en" %}} himself.

## The fight against a second Hyksos

<a name="f92d"></a>
Pharaoh does everything he can to prevent the Israelites from becoming a great people, but whatever he tries, he fails — and the failure plays out almost like a parody, point for point.
...
By any ordinary measure, Moses does not look like hero material.

He is the one meant to rescue Israel because of the covenant God has with his people, and yet {{% bible val="he forgets to circumcise his own son — the one condition of that covenant on his side — so that his non-Israelite wife has to rescue him instead" link="exo:4,24-25" lang="en" %}}.

Trusting God is something he has to learn. One telling example comes {{% bible val="when he throws his staff to the ground and it turns into a snake, and he is told to grab it by the tail — when every child knows you catch a snake behind the head, or it bites you" link="exo:4,2-5" lang="en" %}}.

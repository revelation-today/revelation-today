...
Chapter 7 paints the same picture through different imagery, beginning with Babel:
...
Babylon was symbolized by a lion in both [statues](https://en.wikipedia.org/wiki/Lion_of_Babylon) and [portraits](https://en.wikipedia.org/wiki/Lion_of_Babylon), and Jeremiah likely draws on the same image when he describes the judgment of Edom in terms of a {{% bible val="lion and eagle" link="jer:49,19-22" lang="en" %}}.
...
The bear raised up on one side pictures the joint Median-Persian Empire, in which the Persian side was smaller at first but eventually took the lead. The three ribs, together with the command to "devour," describe its three major conquests: Lydia (547 BC), Babel (539 BC), and Egypt (525 BC).
...
The leopard captures the rapid expansion of Alexander's kingdom from Greece all the way to India in less than two decades. After his death, the kingdom split into four successor states — the four heads.
...
Rome conquered the last of the Greek successor kingdoms and became the greatest empire yet, crushing everything with iron strength — the same iron that appears as {{% bible val="the material of the fourth kingdom in chapter 2" link="dan:2,40" lang="en" %}}.

## The end of the kingdoms

Both chapters end the same way: with a divine event. In chapter 2 it's described as “{{% bible val="a stone was cut out by no human hand, and it struck the image on its feet of iron and clay, and broke them in pieces" link="dan:2,34" lang="en" %}}" and “{{% bible val="the stone that struck the image became a great mountain and filled the whole earth." link="dan:2,35" lang="en" %}}”

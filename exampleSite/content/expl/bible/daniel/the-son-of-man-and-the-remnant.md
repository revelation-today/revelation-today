...
<a name="ba9d"></a>
The title comes from a vision in Daniel:
...
<a name="ca53"></a>
So what is the calling and destiny of this Son of Man — that is, of Israel? Let's read on.
...
This describes the same kingdoms of the earth {{% int_link val="we discussed earlier" link="/expl/bible/daniel/the-four-kingdoms-in-daniel" %}}: the first part gives the elements of the vision and their actions, and the second part interprets them.

Let's line up the interpreted elements:
...
A few things stand out here. The boastful speech is really speech against God — oppressing his people and their law — so the attack on his people is an attack on him, and the judgment that follows is God's own response. The defeat of the holy people is only temporary, lasting just "3.5 times," with the defeat always coming before the victory. The judgment in favor of the holy people means the opposing kings are destroyed once and for all. And the possession of the kingdom is bound up with the fact that all rulers will worship him — this Son of Man who is also, somehow, Israel.

## The problem

<a name="9d11"></a>
On the surface, this sounds like Israel will rule the world at some point. But there's a problem: the Son of Man receives worship, and worship belongs to God alone.

So how do we resolve that? The prophets, when they speak of the Day of the Lord, say that only a {{% int_link val="remnant of Israel will remain" link="/expl/background/israel/the-remnant-of-israel" %}}. So perhaps "the holy people" here refers to that future remnant, not the nation as a whole.
...
What he saved, in the end, was the {{% int_link val="remnant of Israel" link="/expl/background/israel/the-remnant-of-israel" %}}.

...
<a name="09b7"></a>
Die sieben Hügel, auf denen die Frau sitzt, sind {{% bible val="sieben Hügel" link="rev:17,9" lang="de" %}}, die Rom identifizieren — ein nahezu einhelliges Fazit unter Auslegern, da Rom in der Antike als „die Stadt auf sieben Hügeln" bekannt war. Für die ersten Leser war Rom der Sitz des Kaisers, gepriesen als Herr der Herren und König der Könige, als wäre er Gott gleich — das ist keine Prophezeiung über den Papst oder irgendjemand anderen, der später zufällig in Rom lebte.

Zugleich können Hügel auch für Königreiche stehen, denn der Text deutet sie im weiteren Verlauf als Könige, und jedem König ist ein Königreich zugeordnet. Diese Lesart wird gestützt durch das größte Königreich, das in {{% bible val="Jesaja" link="isa:2,2" lang="de" %}} als Berg dargestellt wird, durch {{% bible val="Babylon, das als Berg beschrieben wird" link="jer:51,25" lang="de" %}}, und durch den {{% bible val="Berg, der bei Daniel die Erde erfüllt als das neue gottgemäße Königreich" link="dan:2,35" lang="de" %}}. Edoms eigenes bergiges Stammland gab Anlass zu einer ähnlichen Sprache ({{% bible val="Edoms Berg, der Berg Seïr" link="ezk:35,3" lang="de" %}}), wobei dort der Berg Edoms buchstäbliches Gebiet ist und kein rein symbolisches Bild.

[Wer sind die sieben Könige?](https://www.bibleserver.com/SLT/Offenbarung17%2C10) Fünf sind bereits gefallen, einer regiert gegenwärtig, und ein siebter muss noch kommen und wird nur kurz regieren. Zusammen beschreiben sie eine chronologische Abfolge und zeigen, dass die Könige das Tier während dieser ganzen Zeitspanne unterstützen. Dies ist einer der am meisten diskutierten Abschnitte der Offenbarung, wenn es um die Datierung des Buches geht: Manche Forscher versuchen, tatsächliche Kaiser ab Julius Caesar oder Augustus durchzuzählen, um bei einem bestimmten „sechsten König" (meist Nero) zu landen, und argumentieren, dass dies auf ein Datum in den späten 60er Jahren n. Chr. hindeutet; die Mehrheitsmeinung folgt dem eigenen Zeugnis der frühen Kirche (Irenäus), dass Johannes unter Domitian Mitte der 90er Jahre n. Chr. schrieb, und liest die Abfolge eher symbolisch, so wie wir es hier tun. Wir werden nicht versuchen, einen bestimmten sechsten König zu benennen; es geht nicht um eine exakte Kopfzählung, sondern darum, dass der letzte Countdown nahe ist, {{% bible val="ein Aufruf, wachsam zu bleiben" link="rev:16,15" lang="de" %}}. Eine ausführlichere Betrachtung, wie diese Datierungsfrage sich durch die ganze Seite zieht, findet sich unter {{% int_link val="wer die Offenbarung schrieb, und wann" link="/expl/topics/others/who-wrote-revelation-and-when" %}}.

Das Tier selbst {{% bible val="kommt dann als ein achter König, der zugleich einer der Sieben ist" link="rev:17,11" lang="de" %}}. In der späteren christlichen Tradition (wenn auch nicht im Wortschatz des Neuen Testaments selbst) wurde der Sonntag als „der achte Tag" bezeichnet, als Symbol für den Beginn einer neuen Schöpfung nach Christi Auferstehung „am dritten Tag" ({{% bible val="Christus am dritten Tag auferweckt" link="1co:15,4" lang="de" %}}). Wenn diese spätere Assoziation hier im Blick ist, wäre das Auftreten des Tieres als achter König ein falscher Anspruch auf dieselbe Art von Erneuerung — eine gefälschte Auferstehung. Das Thema der eigenen Auferstehung des Tieres ist bereits {{% bible val="in Kapitel 13" link="rev:13,3-4" lang="de" %}} und in {{% bible val="Kapitel 16" link="rev:16,13" lang="de" %}} aufgetaucht, wo manche Ausleger vorgeschlagen haben, dass die Frösche an die ägyptische Göttin Heqet erinnern, die mit Geburt und Auferstehung in Verbindung gebracht wird — eine anregende, aber alles andere als sichere Verbindung, neben dem deutlicher gesicherten Bezug zu den Plagen des Exodus. Setzt man diese Teile zusammen, liest sich das Auftreten des Tieres am achten Tag als Anspruch auf Unbesiegbarkeit. Doch das ist ein falscher Anspruch: Es wurde bereits entlarvt als „das, was war und nicht ist und ins Verderben geht". Das bestätigt, dass das Tier eines der Sieben ist — kein Superheld, der über ihnen steht.

---
title: "Bagian 2: Siapakah Sang Pelacur Babel?"
weight: 3
...
<a name="e96e"></a>
Model bagi sang pelacur dalam {{% bible val="kitab Wahyu" link="rev:17" lang="ind" %}} tampaknya berasal dari Yeremia 2:20–4:30:
...
- Ia {{% bible val="menggoda orang lain untuk berbuat dosa" link="jer:2,33" lang="ind" %}}.
- {{% bible val="Darah orang-orang yang tidak bersalah melekat padanya, namun ia merasa dirinya tidak bersalah" link="jer:2,34-35" lang="ind" %}}.
...
Tutup dada Imam Besar, {{% bible val="bertuliskan 'Kudus bagi TUHAN'" link="exo:28,35-38" lang="ind" %}}, memiliki lawan yang kelam pada nama yang tertulis di dahi sang pelacur: "{{% bible val="Babel besar, ibu dari segala pelacur dan kekejian bumi" link="rev:17,5" lang="ind" %}}."
...
- Tirus {{% bible val="membuat perjanjian dengan Allah" link="1ki:5,12" lang="ind" %}} untuk membantu membangun bait suci, namun kemudian {{% bible val="dipanggil untuk dihakimi karena menjual orang-orang Yahudi ke dalam perbudakan" link="amo:1,9" lang="ind" %}} dan {{% bible val="disebut sebagai pelacur" link="isa:23,15-18" lang="ind" %}}.
...
Sebaliknya, gereja dipanggil untuk {{% bible val="berjaga-jaga dan waspada" link="rev:16,15" lang="ind" %}} dan {{% bible val="sadar diri" link="rev:3,17-18" lang="ind" %}}, agar tidak berakhir {{% bible val="dipermalukan seperti Babel" link="rev:17,16" lang="ind" %}}.

## Aspek ekonomi

<a name="f24d"></a>
Istilah "pelacur" mencakup segala bentuk hubungan yang tidak sah — baik yang bersifat keagamaan, politik, ekonomi, atau kombinasi dari ketiganya. {{% bible val="Niniwe" link="nam:3,4-5" lang="ind" %}} dan {{% bible val="Tirus" link="isa:23,15-18" lang="ind" %}} keduanya layak mendapat sebutan itu karena mereka membawa kebinasaan dan pencemaran bagi bangsa-bangsa melalui penindasan ekonomi dan penyebaran penyembahan berhala.

Hubungan ekonomi memiliki kecenderungan untuk berubah menjadi hubungan keagamaan — melalui {{% bible val="persembahan bait suci" link="mic:1,7" lang="ind" %}}, {{% bible val="ketergantungan ekonomi" link="nam:3,4" lang="ind" %}}, atau {{% bible val="ikatan pernikahan politik (Izebel sendiri menikah ke dalam kerajaan lain)" link="2ki:9,22" lang="ind" %}}. Kaitan terkuat dengan {{% bible val="perzinaan Babel dengan raja-raja bumi" link="rev:17,2" lang="ind" %}} adalah Tirus, yang {{% bible val="akan menjalankan perdagangannya dengan semua kerajaan bumi" link="isa:23,17" lang="ind" %}} — atau, dalam terjemahan yang lebih harfiah, [berzina dengan kerajaan-kerajaan bumi](https://biblehub.com/interlinear/isaiah/23-17.htm). {{% bible val="Daftar barang dagangan Babel" link="rev:18,12-13" lang="ind" %}} dalam kitab Wahyu sangat mirip dengan {{% bible val="daftar yang sama untuk Tirus" link="ezk:27" lang="ind" %}}. Tirus dahulu adalah {{% bible val="pelabuhan dunia, membuat semua orang kaya sementara ia sendiri dibayar dalam bentuk hasil bumi, dalam kasusnya gandum" link="isa:23,1-3" lang="ind" %}}, dan pada {{% bible val="akhir pasal itu ia secara terbuka disebut sebagai pelacur, keuntungannya dari kekayaan bangsa-bangsa digambarkan sebagai 'upah pelacurannya'" link="isa:23,16-18" lang="ind" %}}.

Kitab Wahyu menarik hubungan yang sama: para raja {{% bible val="berzina dengan Babel" link="rev:18,3" lang="ind" %}} dan {{% bible val="menjadi kaya karenanya" link="rev:18,9" lang="ind" %}}. Pakaian dan perhiasan sang pelacur sendiri, yang diambil dari {{% bible val="daftar perdagangan yang sama itu" link="ezk:27" lang="ind" %}}, adalah simbol kekayaan itu sendiri. Jadi sang pelacur menggoda ke arah penyembahan berhala melalui kekayaan — daya tarik yang sama yang {{% bible val="dianggap begitu menarik oleh Yehuda" link="jer:4,30" lang="ind" %}}, dan yang sama dengan yang {{% bible val="digunakan Izebel" link="2ki:9,30" lang="ind" %}}.
...
- dan aspek-aspek lain dari kehidupan sehari-hari, seperti {{% int_link val="koin" link="/expl/content/harlot/the-harlot-in-revelation-a-mocking-of-the-roman-empire" %}}, hari libur umum, dan sejenisnya.

Melalui semua ini, ia menawarkan sebuah injil tandingan bagi Yesus, menjanjikan

- {{% bible val="keamanan" link="rev:13,4" lang="ind" %}} melalui ketakutan akan {{% bible val="perang" link="rev:13,7" lang="ind" %}} atau {{% bible val="penganiayaan" link="rev:13,10" lang="ind" %}},
- kekayaan melalui {{% bible val="eksploitasi terhadap yang lemah" link="rev:6,5-6" lang="ind" %}} atau {{% bible val="pengucilan terhadap siapa pun yang tidak mau tunduk" link="rev:13,16-17" lang="ind" %}},
- {{% bible val="rasa superioritas" link="rev:13,13-14" lang="ind" %}},
- dan {{% bible val="pembungkaman suara-suara yang tidak menyenangkan" link="rev:17,6" lang="ind" %}}.

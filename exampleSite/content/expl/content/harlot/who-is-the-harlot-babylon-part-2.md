...
<a name="89fc"></a>
The model for the harlot in {{% bible val="Revelation" link="rev:17" lang="en" %}} appears to come from Jeremiah 2:20–4:30:
...
But in chapters {{% bible val="17" link="rev:17,4" lang="en" %}} and {{% bible val="18" link="rev:18,16" lang="en" %}}, the harlot in Revelation is dressed in materials that echo the high priest of the Old Testament:
...
The high priest's plate, {{% bible val="inscribed 'Holy to the Lord'" link="exo:28,35-38" lang="en" %}}, has its dark counterpart in the name written on the harlot's forehead: "{{% bible val="Babylon the great the mother of harlots and of the abominations of the earth" link="rev:17,5" lang="en" %}}."
...
Ezekiel gives the same picture from another angle, where God confronts Jerusalem for {{% bible val="acting as a harlot dressed in those same priestly garments" link="ezk:16,13-26" lang="en" %}}. Across all these passages, the harlot is portrayed as God's own priest and lover, turned unfaithful.

This isn't a one-off image, either — several Old Testament cities are described the same way:
- Tyre {{% bible val="made a covenant with God" link="1ki:5,12" lang="en" %}} to help build the temple, yet was {{% bible val="called to judgment for selling Jews into captivity" link="amo:1,9" lang="en" %}} and was {{% bible val="called a harlot" link="isa:23,15-18" lang="en" %}}.
- Nineveh {{% bible val="humbled itself before the Lord, and he had mercy on them" link="jon:3,5-10" lang="en" %}}, but {{% bible val="later it was judged for being a harlot" link="nam:3,4-7" lang="en" %}}.
- Israel had a covenant with God but broke faith so often that it too was {{% bible val="called a harlot" link="ezk:16,15-41" lang="en" %}}; in Ezekiel, it's specifically Israel's political and economic dependence on other nations, and the idolatry that came with it, that earns it that label.
...
- and other threads of daily life, such as {{% int_link val="coins" link="/expl/content/harlot/the-harlot-in-revelation-a-mocking-of-the-roman-empire" %}}, public holidays, and the like.

Through all of this, she offers a rival gospel to Jesus, promising
...
- wealth through {{% bible val="abuse of the weak" link="rev:6,5-6" lang="en" %}} or {{% bible val="exclusion of anyone who won't comply" link="rev:13,16-17" lang="en" %}},

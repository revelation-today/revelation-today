...
17. bölüm fahişe Babil hakkındadır, ama onu tanımlamak kolay değildir, çünkü {{% bible val="bu bölümde birbiriyle etkileşim içinde olan çok sayıda karakter vardır" link="rev:17" lang="tr" %}}. Onlara birer birer bakalım.
...
8. ve 11. ayetlerde canavar üç kez şöyle tanımlanır:

- {{% bible val="bir zamanlar vardı, şimdi yok, ama Uçurum'dan çıkıp yıkımına gidecek" link="rev:17,8" lang="tr" %}}
- {{% bible val="bir zamanlar vardı, şimdi yok, ama gelecek" link="rev:17,8" lang="tr" %}}
- {{% bible val="bir zamanlar vardı, şimdi yok, ... yıkımına gidiyor" link="rev:17,11" lang="tr" %}}

Bu, Tanrı'nın Vahiy 1:8'de Ebedi Olan, {{% bible val="var olan, var olmuş ve gelecek olan" link="rev:1,8" lang="tr" %}} şeklindeki kendi tanımının bir parodisidir.

## Yedi tepe ve yedi kral

<a name="9b63"></a>
Kadının üzerinde oturduğu yedi tepe, Roma'yı tanımlayan {{% bible val="yedi tepedir" link="rev:17,9" lang="tr" %}}. İlk okuyucular için Roma, imparatorun makam yeriydi; imparator, sanki Tanrı'yla eşitmiş gibi Rablerin Rabbi ve Kralların Kralı olarak övülüyordu — bu, Papa ya da daha sonra Roma'da yaşamış olan başka biri hakkında bir kehanet değildir.

Aynı zamanda tepeler krallıkları da temsil edebilir, çünkü metin onları kral olarak yorumlamaya devam eder ve her kralın kendine ait bir krallığı vardır. Bu okuma, {{% bible val="Yeşaya'da" link="isa:2,2" lang="tr" %}} en büyük krallığın bir dağ olarak resmedilmesiyle, {{% bible val="Babil'in bir dağ olarak tanımlanmasıyla" link="jer:51,25" lang="tr" %}}, {{% bible val="Edom'un da aynı şekilde tanımlanmasıyla" link="ezk:35,3" lang="tr" %}} ve {{% bible val="Daniel'de yeryüzünü dolduran, yeni tanrısal krallığı temsil eden dağla" link="dan:2,35" lang="tr" %}} desteklenir.

[Yedi kral kimdir?](https://www.bibleserver.com/NIV/Revelation17%3A10) Beşi zaten düşmüştür, biri şu anda hüküm sürmektedir ve yedincisi henüz gelmemiştir, gelince de yalnızca kısa bir süre hüküm sürecektir. Birlikte kronolojik bir diziyi tanımlarlar ve bu süre boyunca kralların canavarı desteklediğini gösterirler. Bu sayı kesin bir rakama bağlanmak için değil, son geri sayımın yakın olduğunu göstermek içindir — {{% bible val="uyanık kalma çağrısıdır" link="rev:16,15" lang="tr" %}}.

Ardından canavarın kendisi de {{% bible val="yedilerden biri olan sekizinci bir kral olarak gelir" link="rev:17,11" lang="tr" %}}. İsa, Şabat'tan sonraki gün olan sekizinci günde dirildi ve canavarın kendi dirilişi teması zaten {{% bible val="13. bölümde" link="rev:13,3-4" lang="tr" %}} ve kurbağaların doğum ve diriliş tanrıçası Mısır tanrıçası Heket'i hatırlattığı {{% bible val="16. bölümde" link="rev:16,13" lang="tr" %}} işlenmişti. Bu parçaları birleştirince, canavarın sekizinci günde ortaya çıkması bir yenilmezlik iddiası olarak okunur. Ama bu sahte bir iddiadır: canavar zaten "bir zamanlar vardı, şimdi yok ve yıkımına gidiyor olan" diye deşifre edilmiştir. Bu da canavarın yedilerden biri olduğunu doğrular — onların üzerinde duran bir süper kahraman değil.
...
| *Sadakat* **Çocuklar** | *Sadakat* **Çocuklar** | |
...
| Jezebel **kraliçedir** {{% bible val="1.Kr.16/31" link="1ki:16,31" lang="tr" %}} | Fahişe **kraliçedir** {{% bible val="Vah.17/1-2" link="rev:17,1-2" lang="tr" %}} ({{% bible val="Vah.17/18" link="rev:17,18" lang="tr" %}}, {{% bible val="Vah.18/7" link="rev:18,7" lang="tr" %}}) |
| **{{% bible val="halkı kandırır" link="1ki:21,25" lang="tr" %}}** | **{{% bible val="halkı kandırır" link="rev:17,2" lang="tr" %}}** ({{% bible val="Vah.2/20" link="rev:2,20" lang="tr" %}}) |
| *Putperestlik* yoluyla **fuhuş** {{% bible val="2.Kr.9/22" link="2ki:9,22" lang="tr" %}} ({{% bible val="2 Tar.21/13" link="2ch:21,13" lang="tr" %}}) | *Canavarla işbirliği* yoluyla **fuhuş** {{% bible val="Vah.17/1-2" link="rev:17,1-2" lang="tr" %}} ({{% bible val="Vah.17/5" link="rev:17,5" lang="tr" %}}, {{% bible val="Vah.2/20-22" link="rev:2,20-22" lang="tr" %}}) |
| **{{% bible val="Büyücü kullanır" link="2ki:9,22" lang="tr" %}}** | **{{% bible val="Büyücülük kullanır" link="rev:18,23" lang="tr" %}}** |
| **{{% bible val="Ekonomik çıkar peşindedir" link="1ki:21" lang="tr" %}}** | **{{% bible val="Ekonomik zenginliğe bağımlıdır" link="rev:18,11-19" lang="tr" %}}** |
| **{{% bible val="Kutsallara zulmeder ve onları öldürür" link="1ki:18,4" lang="tr" %}}** ({{% bible val="1.Kr.19/2" link="1ki:19,2" lang="tr" %}}) | **{{% bible val="Kutsallara zulmeder ve onları öldürür" link="rev:17,6" lang="tr" %}}** |
| **{{% bible val="Bir kalıntı direnir" link="1ki:18,18" lang="tr" %}}** ({{% bible val="1.Kr.19/18" link="1ki:19,18" lang="tr" %}}, {{% bible val="2.Kr.9/22" link="2ki:9,22" lang="tr" %}}) | **{{% bible val="Bir kalıntı direnir" link="rev:17,14" lang="tr" %}}** |
| **{{% bible val="Tanrı tanıkların kanının hesabını sorar" link="2ki:9,7" lang="tr" %}}** | **{{% bible val="Tanrı tanıkların kanının hesabını sorar" link="rev:19,2" lang="tr" %}}** |

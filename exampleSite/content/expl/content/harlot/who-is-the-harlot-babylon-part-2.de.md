---
title: "Teil 2: Wer ist die Hure Babel?"
weight: 3
...
<a name="e96e"></a>
Das Vorbild für die Hure in der {{% bible val="Offenbarung" link="rev:17" lang="de" %}} scheint aus Jeremia 2,20–4,30 zu stammen:

- {{% bible val="Juda wird eine Hure genannt" link="jer:2,20" lang="de" %}} mit {{% bible val="der Stirn einer Hure, die ohne Scham handelt" link="jer:3,3" lang="de" %}}.
- Sie {{% bible val="verführt andere zur Sünde" link="jer:2,33" lang="de" %}}.
- {{% bible val="Das Blut Unschuldiger klebt an ihr, und sie fühlt sich unschuldig" link="jer:2,34-35" lang="de" %}}.
- {{% bible val="Ihr Gewand ist scharlachrot, sie schmückt sich mit Gold" link="jer:4,30" lang="de" %}}.
- {{% bible val="Doch ihre Liebhaber verachten sie und wollen sie töten" link="jer:4,30" lang="de" %}}.
...
Das Muster, das sich zeigt, ist durchgängig: Die Hure ist das, was eine frühere Beziehung zu Gott darstellt, sobald sie sich stattdessen dem Götzendienst zugewandt hat. Das ist die Warnung an die Gemeinde — lasst euch nicht an die Welt verhuren, so wie {{% bible val="Pergamon durch Bileam" link="rev:2,14" lang="de" %}} oder {{% bible val="Thyatira durch Isebel" link="rev:2,20-22" lang="de" %}}.

Stattdessen ist die Gemeinde aufgerufen, {{% bible val="wach und wachsam zu sein" link="rev:16,15" lang="de" %}} und {{% bible val="sich selbst zu erkennen" link="rev:3,17-18" lang="de" %}}, damit sie nicht {{% bible val="beschämt endet wie Babylon" link="rev:17,16" lang="de" %}}.

## Der wirtschaftliche Aspekt

<a name="f24d"></a>
Der Begriff „Hure" umfasst jede unerlaubte Beziehung — religiös, politisch, wirtschaftlich oder eine Mischung aus allen dreien. {{% bible val="Ninive" link="nam:3,4-5" lang="de" %}} und {{% bible val="Tyrus" link="isa:23,15-18" lang="de" %}} erhalten dieses Etikett beide, weil sie den Nationen durch wirtschaftliche Unterdrückung und die Verbreitung des Götzendienstes Verderben und Verunreinigung brachten.
...
- und andere Fäden des täglichen Lebens, wie {{% int_link val="Münzen" link="/expl/content/harlot/the-harlot-in-revelation-a-mocking-of-the-roman-empire" %}}, öffentliche Feiertage und Ähnliches.

Durch all das bietet sie ein rivalisierendes Evangelium zu Jesus an und verspricht

- {{% bible val="Sicherheit" link="rev:13,4" lang="de" %}} durch die Furcht vor {{% bible val="Krieg" link="rev:13,7" lang="de" %}} oder {{% bible val="Verfolgung" link="rev:13,10" lang="de" %}},
- Reichtum durch {{% bible val="Ausbeutung der Schwachen" link="rev:6,5-6" lang="de" %}} oder {{% bible val="Ausgrenzung all derer, die nicht mitmachen" link="rev:13,16-17" lang="de" %}},
- {{% bible val="ein Gefühl der Überlegenheit" link="rev:13,13-14" lang="de" %}},
- und {{% bible val="das Zum-Schweigen-Bringen unbequemer Stimmen" link="rev:17,6" lang="de" %}}.

Da Babylon {{% int_link val="viele Parallelen zu Isebel" link="/expl/content/harlot/who-is-the-harlot-babylon-part-1" %}} aufweist, mag dies eine besondere Warnung insbesondere für Gemeindeleiter bedeuten. Aber der Aufruf zur Achtsamkeit und Selbstprüfung gilt für alle. Vielleicht ist genau das der Grund, warum Babylon nicht mit schärferen Konturen gezeichnet wird — {{% bible val="damit du gezwungen bist, immer weiter zu reflektieren und Tag für Tag aus ihr herauszutreten" link="rev:18,4" lang="de" %}}. Denn Babylon ist überall.

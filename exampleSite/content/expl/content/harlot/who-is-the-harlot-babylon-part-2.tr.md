...
<a name="bc8e"></a>
{{% bible val="Vahiy" link="rev:17" lang="tr" %}}'deki fahişenin modeli, görünüşe göre Yeremya 2:20–4:30'dan geliyor:

- {{% bible val="Yahuda bir fahişe olarak adlandırılır" link="jer:2,20" lang="tr" %}}, {{% bible val="utanmadan davranan bir fahişenin alnına sahiptir" link="jer:3,3" lang="tr" %}}.
- {{% bible val="Başkalarını günaha teşvik eder" link="jer:2,33" lang="tr" %}}.
- {{% bible val="Üzerinde masumların kanı vardır ve kendini masum hisseder" link="jer:2,34-35" lang="tr" %}}.
- {{% bible val="Elbisesi kırmızıdır, kendini altınla süsler" link="jer:4,30" lang="tr" %}}.
- {{% bible val="Ama sevgilileri ondan tiksinir ve onu öldürmek ister" link="jer:4,30" lang="tr" %}}.
...
Ortaya çıkan örüntü tutarlıdır: fahişe, Tanrı'yla eskiden var olan bir ilişkinin, puta tapmaya döndüğünde aldığı hâldir. Kiliseye verilen uyarı da budur — {{% bible val="Bergama'nın Balam aracılığıyla" link="rev:2,14" lang="tr" %}} ya da {{% bible val="Thyatira'nın İzebel aracılığıyla" link="rev:2,20-22" lang="tr" %}} yaptığı gibi kendini dünyaya fahişe gibi satmamalısın.

Bunun yerine kilise, {{% bible val="uyanık ve dikkatli olmaya" link="rev:16,15" lang="tr" %}} ve {{% bible val="kendinin farkında olmaya" link="rev:3,17-18" lang="tr" %}} çağrılır, öyle ki {{% bible val="Babil gibi utanç içinde kalmasın" link="rev:17,16" lang="tr" %}}.

## Ekonomik boyut

<a name="fb4b"></a>
Fahişe terimi, dini, siyasi, ekonomik ya da bu üçünün bir karışımı olsun, her türlü meşru olmayan ilişkiyi kapsar. {{% bible val="Ninova" link="nam:3,4-5" lang="tr" %}} ve {{% bible val="Sur" link="isa:23,15-18" lang="tr" %}}, uluslara ekonomik baskı ve putperestliğin yayılması yoluyla yıkım ve kirlenme getirdikleri için ikisi de bu adı hak eder.
...
- {{% bible val="ideoloji" link="rev:13,12" lang="tr" %}},
- ve {{% int_link val="madeni paralar" link="/expl/content/harlot/the-harlot-in-revelation-a-mocking-of-the-roman-empire" %}}, resmi tatiller ve benzerleri gibi günlük hayatın diğer iplikleri.

Bütün bunlar aracılığıyla fahişe, İsa'ya rakip bir müjde sunar ve şunları vaat eder:

- {{% bible val="savaş" link="rev:13,7" lang="tr" %}} ya da {{% bible val="zulüm" link="rev:13,10" lang="tr" %}} korkusuna karşı {{% bible val="güvenlik" link="rev:13,4" lang="tr" %}},
- {{% bible val="zayıfların istismarı" link="rev:6,5-6" lang="tr" %}} ya da {{% bible val="uyum sağlamayan herkesin dışlanması" link="rev:13,16-17" lang="tr" %}} yoluyla zenginlik,
- {{% bible val="bir üstünlük duygusu" link="rev:13,13-14" lang="tr" %}},
- ve {{% bible val="rahatsız edici seslerin susturulması" link="rev:17,6" lang="tr" %}}.

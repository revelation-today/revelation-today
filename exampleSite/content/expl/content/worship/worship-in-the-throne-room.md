...
<a name="3c72"></a>
The verse at the end of the previous chapter already mentioned the throne room of God, but the links run deeper: the throne room section echoes phrases from the first three chapters that address the situation of the church.
...
These parallels give the Church a vision of their own spiritual reality, and a model for how to follow Christ's example. The reality shown in this vision is part of what the church is meant to act upon.

{{% bible val="Daniel 7" link="dan:7" lang="en" %}} offers a striking parallel to chapters 4 and 5 of the Book of Revelation:
...
- the {{% bible val="decision about Ahab's death" link="1ki:22,19-23" lang="en" %}}.

## Why is worship the answer?

<a name="c3dc"></a>
The problems in the churches can be grouped as follows:
...
- The more we know and understand the original — God himself — the less we are swayed by false teachings.
- When we know God and worship him as he truly is, we understand ourselves better and see where we need him.
- When we find our place in relation to God, our priorities fall into place: if God is not first, everything else ends up in the wrong place.
...
Looking ahead at the coming events, we see that:
- {{% int_link val="the seals cause tremendous trouble, but their purpose is to expose Satan's wickedness" link="/expl/content/seals/the-mystery-of-the-four-horse-men" %}}, to save as many people as possible, and to hasten the end of time;
- {{% int_link val="the trumpets expose the false things that people rely on — the fifth and sixth trumpets reveal that the real cause of the trouble is people's reliance on demons" link="/expl/content/trumpets/the-trumpets-in-revelation" %}};
- {{% int_link val="the bowls are where God lays everything bare to warn people away from deception, showing in the sixth and seventh bowls the end of the beast and its followers" link="/expl/content/bowls/the-bowls-of-wrath" %}}.

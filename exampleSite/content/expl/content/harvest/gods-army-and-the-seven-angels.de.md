...
„Ewiges Evangelium" ist ein bemerkenswerter Ausdruck, und er geht zurück auf Psalm 96: „[Verkündigt Tag für Tag sein Heil](https://biblehub.com/interlinear/psalms/96-2.htm)." Das hebräische Verb hinter „verkündigt" ist dort „[basar](https://biblehub.com/hebrew/1319.htm)" – gute Nachricht ankündigen –, und der griechische Text des Alten Testaments gibt es mit der euangelizō-Wortgruppe wieder, der Verbform von evangelion, Evangelium. Und der Ausdruck „Tag für Tag" kann auch die Bedeutung „ewig" tragen, ähnlich dem redensartlichen „Tag für Tag" in {{% bible val="den Sprüchen" link="pro:8,30" lang="de" %}}.
...
Der zweite Engel verkündet den Fall Babylons, während der dritte eine ernste Warnung vor dem Gericht für jeden ausspricht, der dem Tier nachgibt. Zusammen spiegeln sie das {{% bible val="Weissagen im Trauergewand" link="rev:11,3" lang="de" %}} und die {{% bible val="warnenden Gerichte" link="rev:11,5" lang="de" %}} wider, die schon die beiden Zeugen überbracht haben.

Das wirft die naheliegende Frage auf: Werden die Völker tatsächlich hören? Einen starken Hinweis darauf gibt uns die Geschichte der Zeugen: {{% int_link val="viele wenden sich tatsächlich Gott zu" link="/expl/content/witnesses/the-two-witnesses" %}}.
...
Dennoch gibt es Gründe, die Getreideernte anders zu lesen – dies sollte allerdings eher als Vorschlag denn als gesicherte Schlussfolgerung gelten. Drei Einzelheiten heben sie ab. Erstens wurden die 144.000 bereits früher in diesem Kapitel als Erstlinge vorgestellt, und Erstlinge wurden {{% bible val="normalerweise vom Getreide genommen" link="lev:23,9-14" lang="de" %}} (zusammen mit einem Lammopfer) und dienten als {{% bible val="Unterpfand für die noch ausstehende volle Ernte" link="1co:15,20-23" lang="de" %}} – wenn also das hier geerntete Getreide an die 144.000 erinnern soll, erkauft aus jeder Nation (nach der Lesart, dass die Gemeinde Teil Israels ist, wie sie unter {{% int_link val="Die Gemeinde und Israel" link="/expl/topics/others/dispensionalism-and-its-critic#049e" %}} besprochen wird), würden sie als Erstling aller Nationen dastehen. Ein Erstling könnte technisch auch {{% bible val="von Trauben stammen" link="exo:22,29" lang="de" %}}, aber das ergäbe hier eine merkwürdige Lesart – sollen die Märtyrer tatsächlich der Erstling von Gottes Rache sein? Zweitens umfasst die Kelter sowohl das Sammeln als auch das Zertreten der Trauben, während die Getreideernte, so wie sie erzählt wird, beim Schneiden endet; was nach dem Einbringen des Getreides folgt – {{% bible val="Dreschen" link="jer:51,33" lang="de" %}}, {{% bible val="das Verbrennen der Spreu" link="mat:3,12" lang="de" %}} oder das {{% bible val="Fortwehen" link="psa:1,4" lang="de" %}} – wird schlicht nicht erwähnt, und an anderer Stelle in der Schrift kann {{% bible val="das Ernten auch das Einsammeln von Menschen abbilden, so wie Jesus sagt, die Felder seien reif zur Ernte" link="jhn:4,35" lang="de" %}}. Drittens wird die Getreideernte von „einem wie dem Menschensohn, der auf einer Wolke sitzt und eine Krone trägt" eingebracht – eine Formulierung, die zurückreicht {{% bible val="zu Daniel, wo er das ewige Königreich empfängt und alle Nationen ihn anbeten" link="dan:7,13-14" lang="de" %}}.

Nichts davon ist für sich genommen entscheidend. Nichts in der Szene der Getreideernte selbst verbindet das Getreide ausdrücklich mit den 144.000 aus Vers 4, und königliche, an Daniel angelehnte Bildsprache bedeutet anderswo in der Offenbarung nicht automatisch einen positiven Ausgang: Der verherrlichte Christus, in ganz ähnlich königlichen Begriffen beschrieben, ist derjenige, der später selbst {{% bible val="die Kelter des grimmigen Zornes Gottes, des Allmächtigen, tritt" link="rev:19,15" lang="de" %}}. So mögen die beiden Ernten zwei Möglichkeiten für die Nationen aufzeigen – Gericht oder Rettung –, doch die Leser sollten wissen, dass dies eine Lesart unter mehreren ist; viele sorgfältige Ausleger verstehen beide Ernten als Gericht und unterscheiden sich nur darin, wessen Gericht es ist. Die Geschichte der beiden Zeugen endete damit, dass die Mehrheit Gott die Ehre gab – aber hier bleibt der Ausgang für einen Moment offen.
...
Schaut man noch genauer auf die Zeile „Wer wird dich nicht fürchten, Herr, und deinen Namen preisen? … König der Nationen", verbindet sie sich mit {{% bible val="Jeremia, wo dieselbe Frage über den König der Nationen gestellt wird" link="jer:10,7" lang="de" %}} sowie mit Psalm {{% bible val="86" link="psa:86,8-10" lang="de" %}} und {{% bible val="98" link="psa:98,1-2" lang="de" %}}. Zusammengenommen verweben diese Fäden den Inhalt des Liedes des Mose und des Lammes zu einem einzigen Argument:
...
Das Lied ist mit anderen Worten eine Proklamation, dass alle Nationen zu Gott kommen und ihn anbeten werden – bewirkt durch sein Gericht über ihre Feinde. Sein Jubel gilt nicht nur der eigenen Rechtfertigung der Märtyrer; er gilt ebenso dem Lob, das Gottes Taten den Nationen entlockt haben.

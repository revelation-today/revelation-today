...
- Tanrı vahyi İsa Mesih’e verdi, vahyi veren O’dur, ya da
- İsa vahyin içeriğidir, vahiy İsa hakkında bir vahiydir.

Yunanca her iki okumayı da destekler, ve niyet muhtemelen tam olarak budur: vahiy İsa’dan gelir, ama amacı İsa’yı daha fazla açığa çıkarmaktır. “Kullar” Yuhanna’nın yazdığı imanlılardır — kitabın hitap ettiği kişiler onlardır.

“Yakında olması gerekenler” ifadesi de bilinçli olarak seçilmiştir. Dünya krallıklarının sonunu ve Tanrı’nın egemenliğinin gelişini anlatan {{% int_link val="Daniel 2’deki görüme" link="/expl/bible/daniel/the-four-kingdoms-in-daniel" %}} atıfta bulunur. Fark şudur: Daniel için bu hâlâ gelecekteydi, Yuhanna içinse bu çoktan gerçekleşmeye başlamıştır.

{{% bible val="Bir sonraki ayet" link="rev:1,2" lang="tr" %}} İsa’nın tanıklığına işaret ederek bunu pekiştirir. {{% int_link val="Bunun kitap boyunca merkezi bir tema olduğunu göreceğiz" link="/appl/topics/power/the-power-of-testimony" %}}: İsa sadece bundan söz etmekle kalmaz, yaşayan bir tanıklıktır — bizim de öyle olmamız gerekir.

Bir sonraki ayet aciliyeti daha da netleştirir: “Bu peygamberlik sözlerini yüksek sesle okuyana ne mutlu! Sözlere kulak verip yazılanları yürekten benimseyenlere de ne mutlu! Çünkü zaman yakındır.”

- Bunu incelemeliyiz — o günlerde kitap yüksek sesle okunuyordu, çünkü herkesin bir kopyası yoktu — ama daha önemlisi, onu uygulamalıyız.
...
<a name="8853"></a>
Şimdi, bir Yeni Antlaşma mektubunun girişine çok benzeyen bir bölüm geliyor; mektup yazarları genellikle burada sonrasında geleceklerin temelini atar. Burada da farklı değildir.
...
“{{% bible val="ve sadık tanık, ölüler arasından ilk doğan, dünya krallarının hükümdarı İsa Mesih’ten sizlere lütuf ve esenlik olsun. Bizi seven, kanıyla bizi günahlarımızdan özgür kılan," link="rev:1,4-5" lang="tr" %}}”
...
“{{% bible val="ve bizi bir krallık haline getirip Babası Tanrı’nın hizmetinde kâhinler kıldı. Yücelik ve güç sonsuzlara dek O’nun olsun! Amin." link="rev:1,4-6" lang="tr" %}}”

- Bizi çoktan kral ve kâhin yaptı. Şimdiden kralız, ama bunu hâlâ yaşama geçirmemiz gerekiyor — dünyanın hükmettiği şekilde değil.

## Bulutlarla birlikte geliyor

<a name="4542"></a>
“{{% bible val="İşte, bulutlarla geliyor! Her göz O’nu görecek, O’nu mızrakla deleneler bile. O’nun için dövünecek yeryüzünün bütün halkları. Evet, âmin!" link="rev:1,7" lang="tr" %}}”

Bu, Zekeriya’dan bir alıntıdır:

“{{% bible val="Davut soyu ve Yeruşalim’de yaşayanların üzerine lütuf ve yakarış ruhunu dökeceğim. Deştikleri kişiye, yani bana bakacaklar; biricik oğlu için yas tutan biri gibi ardımdan yas tutacak, ilk oğlu için acı çeken biri gibi acı çekecekler. O gün Yeruşalim’de tutulan yas, Megiddo Ovası’ndaki Hadat-Rimmon yasından büyük olacak." link="zec:12,10-11" lang="tr" %}}”

Ancak burada bu, yalnızca İsrail’e değil, tüm yeryüzüne genişletilir. Bu yas, {{% bible val="kralları Yoşiya için tutulan yasla" link="2ch:35,22-25" lang="tr" %}} karşılaştırılır.

Vahiy’deki pasajın ilk kısmı Daniel’den gelir:

“{{% bible val="Gece görümlerimde İnsanoğlu’na benzer birinin göğün bulutlarıyla geldiğini gördüm. Yaklaşıp Eskiden Beri Var Olan’ın yanına geldi, huzura çıkarıldı. Kendisine egemenlik, yücelik ve krallık verildi. Bütün halklar, uluslar, her dilden insan O’na tapındı." link="dan:7,13-14" lang="tr" %}}”

Benzer bir birleşik alıntı, {{% bible val="İsa’nın son zamanlardan söz ettiği" link="mat:24,3" lang="tr" %}} yerde, {{% bible val="Matta’da" link="mat:24,30" lang="tr" %}} da karşımıza çıkar. Ve “yeryüzündeki bütün halklar” ifadesi, {{% bible val="Avram aracılığıyla bütün ulusların kutsanacağı vaadini" link="gen:12,3" lang="tr" %}} yankılar.

Bu pasajları bir araya getirdiğimizde ortaya bir tablo çıkar:

...
- Gott hat Jesus Christus die Offenbarung gegeben, er ist also derjenige, dem sie gegeben wird, oder
- Jesus ist der Inhalt der Offenbarung, sie ist eine Offenbarung über Jesus.

Das Griechische lässt beide Lesarten zu, und wahrscheinlich ist genau das beabsichtigt: Die Offenbarung kommt von Jesus, aber ihr Ziel ist es, mehr von Jesus zu offenbaren. Die „Knechte" sind die Gläubigen, an die Johannes schreibt — sie sind die Adressaten dieses Buches.

Auch die Formulierung „was bald geschehen muss" ist bewusst gewählt. Sie greift die {{% int_link val="Vision aus Daniel 2" link="/expl/bible/daniel/the-four-kingdoms-in-daniel" %}} auf, die das Ende der Weltreiche und das Kommen der Herrschaft Gottes beschreibt. Der Unterschied ist: Für Daniel lag das noch in der Zukunft, für Johannes hat es bereits begonnen.

{{% bible val="Der nächste Vers" link="rev:1,2" lang="de" %}} unterstreicht das, indem er auf das Zeugnis Jesu verweist. {{% int_link val="Wir werden sehen, dass dies ein zentrales Thema des ganzen Buches ist" link="/appl/topics/power/the-power-of-testimony" %}}: Jesus redet nicht nur davon, er ist ein lebendiges Zeugnis — und das sollten wir auch sein.

Der Vers danach macht die Dringlichkeit noch deutlicher: „Glückselig ist, der die Worte der Weissagung liest, und die sie hören und bewahren, was darin geschrieben steht! Denn die Zeit ist nahe."

- Wir sollen dieses Buch studieren — damals wurde es laut vorgelesen, weil nicht jeder ein eigenes Exemplar hatte —, aber wichtiger noch: Wir sollen es anwenden.
...
<a name="bb4f"></a>
Nun folgt ein Abschnitt, der klingt wie der Anfang eines neutestamentlichen Briefes, in dem der Verfasser normalerweise die Grundlage für alles Weitere legt. Auch hier ist das nicht anders.
...
- Er hat uns bereits zu Königen und Priestern gemacht. Wir sind schon jetzt Könige, müssen es aber noch leben — nicht, indem wir herrschen, wie die Welt herrscht.
...
Das ist ein Zitat aus Sacharja:

„{{% bible val="Und ich will über das Haus David und über die Einwohner von Jerusalem den Geist der Gnade und des Gebets ausgießen. Sie werden auf mich sehen, den sie durchbohrt haben, und werden um ihn klagen, wie man klagt um ein einziges Kind, und werden bitterlich um ihn weinen, wie man bitterlich weint um den Erstgeborenen. An jenem Tag wird die Klage in Jerusalem so groß sein wie die Klage von Hadad-Rimmon in der Ebene von Megiddo." link="zec:12,10-11" lang="de" %}}"

Hier jedoch wird das auf die ganze Erde ausgeweitet, nicht nur auf Israel. Diese Trauer wird mit der {{% bible val="Trauer um ihren König Josia" link="2ch:35,22-25" lang="de" %}} verglichen.

Der erste Teil der Passage in der Offenbarung stammt aus Daniel:

„{{% bible val="Ich sah in den Nachtgesichten, und siehe, es kam einer mit den Wolken des Himmels, gleich einem Sohn des Menschen; und er gelangte bis zu dem Hochbetagten und wurde vor ihn gebracht. Und ihm wurde Herrschaft, Ehre und Königtum verliehen, und alle Völker, Stämme und Sprachen dienten ihm." link="dan:7,13-14" lang="de" %}}"

Ein ähnliches Mischzitat findet sich bei {{% bible val="Matthäus" link="mat:24,30" lang="de" %}}, wo {{% bible val="Jesus über die Endzeit spricht" link="mat:24,3" lang="de" %}}. Und „alle Geschlechter der Erde" greift die {{% bible val="Verheißung an Abram auf, dass durch ihn alle Völker gesegnet werden" link="gen:12,3" lang="de" %}}.

Setzt man diese Stellen zusammen, ergibt sich ein Bild:

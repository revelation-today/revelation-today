...
<a name="e9dd"></a>
Einige Beobachtungen weisen uns auf eine bessere Antwort hin:

- Johannes wird beauftragt, {{% bible val="an die sieben Gemeinden zu schreiben" link="rev:1,11" lang="de" %}}, nicht an die Engel.
...
<a name="ab47"></a>
Zusammengenommen weisen diese Beobachtungen auf eine einfachere Antwort hin: Die "Engel der Gemeinden" sind nur eine andere Art, die Gemeinden selbst anzusprechen. Engel und Gemeinde werden durchgängig austauschbar gebraucht.

Das passt zu einem Muster, das in der jüdischen Literatur bereits gut belegt ist, wo eine ganze Gruppe oft angesprochen wird, als wäre sie ein einzelnes Individuum - {{% bible val="Tochter Zion" link="zep:3,14" lang="de" %}} und {{% bible val="Tyrus" link="ezk:27" lang="de" %}} sind beides Beispiele dafür, und Hosea wechselt auf dieselbe Weise zwischen Einzahl und Mehrzahl in {{% bible val="Kapitel 9" link="hos:9,1-6" lang="de" %}} und {{% bible val="Kapitel 14" link="hos:14,1-3" lang="de" %}}. Auch Briefe an Gemeinden waren normalerweise nicht an eine einzelne Person gerichtet, und anderswo werden Gemeinden sowohl in Briefen als auch in prophetischen Reden im {{% bible val="Plural" link="zep:2,1-5" lang="de" %}} angesprochen.

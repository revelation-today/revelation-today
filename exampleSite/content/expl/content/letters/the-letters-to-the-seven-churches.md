...
## The vision behind the letters

<a name="4c46"></a>
Before writing the letters, John records a vision of {{% int_link val="how God envisions the Church" link="/expl/content/vision/the-vision" %}}. Its message is that the Church, pictured as stars and lampstands, is meant to be light — lampstands giving light within the Church, stars giving light to the world — but only through dependence on Jesus, never apart from him. This is exactly what the seven churches are being judged on.

At the beginning of this chapter, we already saw {{% bible val="what Jesus did" link="rev:1,5-6" lang="de" %}}. Now we turn to the situation the churches are actually in, and to what God is doing to move them toward the calling that vision describes.

## The structure of the letters

<a name="4b58"></a>
In each letter, Jesus follows the same basic pattern: he addresses the church in a specific way, praises it for its good works, confronts it for its shortcomings, and gives it a promise — either to overcome its shortcomings or to keep encouraging its good works.

The seven letters themselves are arranged symmetrically:
...
- **Smyrna and Philadelphia.** Both face outside opposition — Smyrna fears imprisonment, Philadelphia struggles with poverty — and in both cases the pressure comes from Jewish opposition. Philadelphia is given the promise that these opponents will eventually convert; Smyrna is given no such promise. Yet in both cases, the churches are simply told to keep the faith and continue their work. Jesus promises to see them through, not that everything they attempt will succeed.

...
<a name="dcbc"></a>
A few observations point us toward a better answer:
...
<a name="8ab4"></a>
Taken together, these observations point to a simpler answer: the "angels of the churches" are just another way of addressing the churches themselves. Angel and church are used interchangeably throughout.

This fits a pattern already well established in Jewish literature, where a whole group is often addressed as though it were a single individual — {{% bible val="Daughter Zion" link="zep:3,14" lang="en" %}} and {{% bible val="Tyrus" link="ezk:27" lang="en" %}} are both examples, and Hosea shifts between singular and plural address in the same way in {{% bible val="chapter 9" link="hos:9,1-6" lang="en" %}} and {{% bible val="chapter 14" link="hos:14,1-3" lang="en" %}}. Letters to churches, likewise, were not normally addressed to a single individual, and elsewhere churches are addressed in the {{% bible val="plural" link="zep:2,1-5" lang="en" %}} in letters and prophetic speeches alike.

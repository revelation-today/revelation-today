...
<a name="adc4"></a>
Jesus stellt sich hier vor als {{% bible val="der, der die Sterne hält und sich inmitten der Leuchter bewegt" link="rev:2,1" lang="de" %}}, und greift damit das zentrale Bild auf, das bereits in {{% bible val="Kapitel 1" link="rev:1,20" lang="de" %}} etabliert wurde: Gläubige sollen Licht sein, und dafür von ihm abhängig sein. Diese Gemeinde muss sich dieses Bild zu Herzen nehmen, sonst riskiert sie, ihre Berufung ganz zu verlieren.

...
Das tausendjährige Reich aus Offenbarung 20 hat mehr konkurrierende Theorien hervorgebracht als fast jede andere Passage des Buches. Statt von einer Theorie auszugehen, wollen wir beim Text selbst und seinem Zusammenhang beginnen und schauen, was ein frischer Blick zutage fördert.
...
- Warum nicht einfach ein neuer Himmel und eine neue Erde – wozu bräuchte der Text überhaupt ein Jahrtausend dazwischen, wenn die Alternative doch nur wäre, dass alle auf Wolken sitzen und Harfe spielen?
...
<a name="b25f"></a>
[Die Episode der 1000 Jahre beginnt mit einem einfachen Wort: „und"](https://biblehub.com/interlinear/revelation/20-1.htm) – und wie man dieses eine Wort auffasst, trägt sich als überraschend gewichtig heraus.

„Und ich sah" ließe sich zeitlich lesen: Nach den gerade erzählten Ereignissen ({{% bible val="der letzten Schlacht" link="rev:19,11-21" lang="de" %}}) wird der Teufel für tausend Jahre gebunden, und alles, was folgt, geschieht danach in dieser Reihenfolge. Oder „und ich sah" ließe sich visionär lesen: Johannes empfängt an dieser Stelle einfach eine neue Vision, die den Teufel für tausend Jahre gebunden zeigt, ohne jede Aussage darüber, wo diese Vision zeitlich im Verhältnis zum Vorherigen einzuordnen ist.
...
<a name="4257"></a>
Es bestehen starke Parallelen zwischen drei Schlachtszenen: {{% bible val="Jesu Schlacht 'vor' dem tausendjährigen Reich" link="rev:19,11-21" lang="de" %}}, {{% bible val="der Schlacht von Gog und Magog nach dem tausendjährigen Reich" link="rev:19,7-10" lang="de" %}}, und den beiden Visionen von Gog und Magog bei Hesekiel, in den Kapiteln {{% bible val="38" link="ezk:38" lang="de" %}} und {{% bible val="39" link="ezk:39" lang="de" %}}. Alle drei teilen dieselbe Form: eine gewaltige Versammlung zum Krieg, eine „Endzeitschlacht", ausgetragen von einem gewaltigen Heer, und Gottes überwältigender, endgültiger Sieg.
...
- Kapitel 19 beschreibt Vernichtung durch das {{% bible val="Schwert" link="rev:19,15" lang="de" %}}, Kapitel 20 durch {{% bible val="Feuer" link="rev:20,9" lang="de" %}} – unterschiedliche Waffen, was auf unterschiedliche Schlachten hindeuten könnte. Doch dasselbe Muster zeigt sich innerhalb der beiden eigenen Visionen Hesekiels, wo beide Waffen in beiden vorkommen: das {{% bible val="Schwert" link="ezk:38,21" lang="de" %}} und das {{% bible val="Feuer" link="ezk:38,22" lang="de" %}} in Kapitel 38, sowie das {{% bible val="Schwert" link="ezk:39,17-21" lang="de" %}} und das {{% bible val="Feuer" link="ezk:39,6" lang="de" %}} in Kapitel 39. Der Wechsel der Waffe beweist also nicht ohne Weiteres zwei getrennte Ereignisse.
- Kapitel 19 und 20 könnten unterschiedliche Erfüllungsgrade beschreiben, aber beide verwenden eine Sprache, die eng den Endzeitschlachten folgt, die bei {{% bible val="Hesekiel" link="ezk:38" lang="de" %}}, {{% bible val="Sacharja" link="zec:12" lang="de" %}} und {{% bible val="Zefanja" link="zep:3" lang="de" %}} beschrieben werden – und in allen dreien ist die beschriebene Schlacht endgültig, nicht eine von mehreren Stufen.
- Kapitel 19 beschreibt {{% bible val="menschliche Heere" link="rev:19,19" lang="de" %}}, während Kapitel 20 {{% bible val="dämonische Heere" link="rev:20,8" lang="de" %}} beschreibt – aber wo genau sagt der Text, dass die Heere in Kapitel 20 rein dämonisch sind? Liest man beide Stellen noch einmal sorgfältig neben {{% bible val="der sechsten Schale" link="rev:16,14" lang="de" %}}: In beiden Kapiteln führt Satan menschliche Heere an, sodass die vermeintliche Unterscheidung möglicherweise nicht standhält.
- Könnte die Reihenfolge der Ereignisse in Daniel {{% bible val="Kapitel 7" link="dan:7" lang="de" %}} mehrere Schlachten stützen, mit der Begründung, dass der Teufel erst nach der Herrschaft der Heiligen besiegt wird? Daniels Vision ist jedoch stark wiederholend: Die Herrschaft der Heiligen erscheint in den Versen {{% bible val="8" link="dan:7,8" lang="de" %}}, {{% bible val="13–14" link="dan:7,14" lang="de" %}}, {{% bible val="19–22" link="dan:7,19-22" lang="de" %}}, {{% bible val="23–25" link="dan:7,23-25" lang="de" %}} und {{% bible val="27" link="dan:7,27" lang="de" %}}, während das Gericht über das Tier in den Versen {{% bible val="9–11" link="dan:7,9-11" lang="de" %}} und {{% bible val="26" link="dan:7,26" lang="de" %}} erscheint – dieselben Ereignisse werden erneut aufgegriffen, keine strenge Zeitlinie. Und bemerkenswerterweise steht {{% bible val="das Öffnen der Bücher" link="dan:7,10" lang="de" %}} vor allem anderen, was jeden Versuch erschwert, die Abfolge als streng chronologisch zu lesen.

## Weitere Argumente für eine Schlacht

<a name="6a0c"></a>
Auch die Abfolge der Schalen selbst weist in dieselbe Richtung. Während der sechsten Schale werden die Heere bei {{% int_link val="Harmagedon versammelt, was sich auf einen Berg bezieht" link="/expl/content/bowls/the-key-to-armageddon" %}}, sodass die Schlacht an dieser Stelle der Erzählung noch bevorsteht. Erst in der siebten Schale wird sie als gewonnen verkündet, gefolgt von einer ausführlichen Schilderung der Niederlage der Hure Babylon und, als ihrem Gegenstück, der Hochzeit der Braut; die Schlacht selbst wird dann ausführlich in {{% bible val="Kapitel 19" link="rev:19,17-21" lang="de" %}} erzählt. Und da {{% bible val="der Beginn der Schalen sie ausdrücklich als die letzten Plagen bezeichnet" link="rev:15,1" lang="de" %}} – das heißt, sie gipfeln in der {{% bible val="Zerstörung des Reiches des Teufels" link="rev:16,18-20" lang="de" %}}, was genau in {{% bible val="Kapitel 19" link="rev:19,17-21" lang="de" %}} geschieht –, liest man jede danach erzählte Schlacht am besten als Rückblick auf Kapitel 19, nicht als ein zweites, späteres Ereignis.

## Das Binden Satans

<a name="4bba"></a>
Der {{% bible val="Beginn von Kapitel 20" link="rev:20,1-3" lang="de" %}} beschreibt das Binden Satans, und die Szene weist eine starke Verbindung zu {{% bible val="Kapitel 12" link="rev:12" lang="de" %}} auf, das den Fall Satans als Folge von Jesu Tod beschreibt. Die Parallelen zwischen beiden Kapiteln reichen tief:

- Die Kapitel {{% bible val="12" link="rev:12,1" lang="de" %}} und {{% bible val="20" link="rev:20,1" lang="de" %}} beginnen beide mit einer himmlischen Szene.
- Kapitel 12 hat einen {{% bible val="Kampf der Engel gegen Satan und seine Helfershelfer" link="rev:12,7-8" lang="de" %}}; Kapitel 20 hat {{% bible val="etwas, das wie ein ähnlicher Kampf der Engel gegen Satan aussieht" link="rev:20,2" lang="de" %}}.
- Als Folge wird Satan hinabgeworfen – auf die {{% bible val="Erde" link="rev:12,9" lang="de" %}} in Kapitel 12, in den {{% bible val="Abgrund" link="rev:20,3" lang="de" %}} in Kapitel 20.
- Er wird an beiden Stellen mit demselben ausführlichen Titel bezeichnet: „{{% bible val="jene alte Schlange, genannt Teufel oder Satan" link="rev:12,9" lang="de" %}}" und „{{% bible val="der Drache, jene alte Schlange, der der Teufel oder Satan ist" link="rev:20,2" lang="de" %}}".
- Beide Kapitel {{% bible val="12" link="rev:12,9" lang="de" %}} und {{% bible val="20" link="rev:20,3" lang="de" %}} erwähnen, dass er die Welt verführt, und in beiden setzt die gegen ihn ergriffene Maßnahme dieser Verführung ein Ende.
- In Kapitel 12 weiß Satan, dass er {{% bible val="nur noch wenig Zeit hat" link="rev:12,12" lang="de" %}}; in Kapitel 20 wird {{% bible val="er für kurze Zeit freigelassen" link="rev:20,3" lang="de" %}}.

## Gibt es nicht auch Unterschiede?

Es gibt ein paar echte Unterschiede, die es abzuwägen gilt. In Kapitel 12 wird Satan auf die {{% bible val="Erde" link="rev:12,9" lang="de" %}} geworfen; in Kapitel 20 in einen Abgrund. Aber in beiden Fällen kommt ein Engel vom Himmel herab, um ihn hinabzuwerfen, und der {{% bible val="Abgrund" link="rev:20,3" lang="de" %}} könnte sich selbst auf der Erde befinden oder sich auf den {{% bible val="Ort des Todes beziehen, der auf der Erde sein kann" link="rev:6,8" lang="de" %}} – der Unterschied könnte also kleiner sein, als er zunächst erscheint.

Es stimmt auch, dass {{% bible val="die Verführung zunimmt, nachdem Satan in Kapitel 12 hinausgeworfen wird" link="rev:13" lang="de" %}}, während {{% bible val="sie in Kapitel 20 gestoppt wird" link="rev:20,3" lang="de" %}}. Aber dieser Gegensatz überzeugt weniger, als er zunächst scheint: Die Verführung nimmt in Kapitel 13 zu, weil gerade das Geheimnis des Glaubens offenbart wurde und die Gemeinde, die dadurch nicht verführt werden kann, als Zeugnis dagegen dasteht – das ist eine andere Dynamik als eine bloße Zu- oder Abnahme von Satans Macht. Außerdem bedeutet die in Kapitel 20 beschriebene Bindung nicht zwingend, dass Satan völlig bewegungsunfähig ist; dieselbe Sprache beschreibt anderswo eine Einschränkung der Autorität statt völliger Machtlosigkeit, wie beim versiegelten Stein bei {{% bible val="Daniel" link="dan:6,17" lang="de" %}} oder {{% bible val="Matthäus" link="mat:27,66" lang="de" %}}.
...
- Glaubst du, dass das tausendjährige Reich besser sein wird als der neue Himmel und die neue Erde? Wenn ja, inwiefern? Wenn nein, warum sollten die Menschen 1000 Jahre warten, statt die eigentliche Sache sofort zu empfangen?
...
Es gibt noch eine weitere Merkwürdigkeit, die die meisten Übersetzungen still glätten. Wörtlich beginnt der Text: „[Und ich sah Throne, und sie setzten sich darauf, und ihnen wurde Gericht gegeben](https://biblehub.com/interlinear/revelation/20-4.htm)." Doch sucht man rückwärts nach einem Bezugswort für „sie" und „ihnen", findet sich kein eindeutiges – der nächstliegende Kandidat ist tatsächlich der Teufel, der zwei Verse zuvor erwähnt wird. Hinzu kommt, dass jedes Verb in der Passage in derselben Zeitform steht (alle im [Aorist](https://de.wikipedia.org/wiki/Aorist)), sodass es überhaupt kein grammatisches Signal für eine zeitliche Abfolge zwischen diesen Handlungen gibt.

Wer mit „sie" gemeint ist, wird erst danach klargestellt: „die, die das Tier nicht angebetet und sein Malzeichen nicht angenommen hatten". Dieses Muster – eine Gruppe zu benennen, bevor erklärt wird, wer sie ist – nennt man [Hysteron-Proteron](https://de.wikipedia.org/wiki/Hysteron-Proteron_(rhetorische_Figur)) („das Letzte vor dem Ersten"), eine Geschichte in umgekehrter Reihenfolge zu erzählen, um den ersten Teil zu betonen. Das kommt noch an anderen Stellen der Offenbarung vor:
- {{% bible val="halte fest und kehre um" link="rev:3,3" lang="de" %}},
- {{% bible val="ich bin reich und bin reich geworden" link="rev:3,17" lang="de" %}},
- {{% bible val="dein Bauch wird bitter werden, aber in deinem Mund wird es süß sein wie Honig" link="rev:10,9" lang="de" %}}.

Liest man rückwärts, in der Reihenfolge, in der die Ereignisse tatsächlich geschahen, ergibt die Passage mehr Sinn: Sie herrschen, weil sie das Tier nicht angebetet, sein Malzeichen nicht angenommen haben und dafür enthauptet wurden.
...
Die Herrschaft gehört also jedem, der Gott treu ist, ob diese Treue ihn das Leben kostet oder etwas Kleineres, etwa {{% bible val="wirtschaftlichen oder sozialen Druck" link="rev:13,15-17" lang="de" %}}.

...
- {{% bible val="Der Überrest Israels wird als die Überlebenden von Israel bezeichnet" link="isa:10,20" lang="de" %}}.
- {{% bible val="Nur der Überrest wird aus dem Exil zurückkommen" link="isa:10,21" lang="de" %}}.
- {{% bible val="Nachdem Gott den Überrest aus Israel holt, wird er bei einem zweiten Mal auch die Nationen erreichen" link="isa:11,11" lang="de" %}}.
- {{% bible val="Gott wird mit einem (kleinen) Überrest starten und ihn dann vergrößern" link="jer:23,3" lang="de" %}}.
...
{{% bible val="Eunuchen waren vom Tempeldiest im Alten Testament ausgeschlossen" link="deu:23,1" lang="de" %}}, aber jetzt haben sie Zugang zum Tempel.
...
- {{% bible val="Einbindung der Nationen" link="isa:66,18-21" lang="de" %}}.
...
Dies bezieht sich vermutlich auf eine {{% bible val="frühere Passage von Jesaja" link="isa:2,2-4" lang="de" %}}, in der alle Nationen nach Jerusalem kommen.
...
{{% bible val="Paulus verstand diesen Begriff so, dass er darum der Diener der Nationen ist." link="rom:15,16" lang="de" %}}

“{{% bible val="Und ich werde auch von ihnen welche als Priester und Leviten nehmen, spricht der HERR." link="isa:66,21" lang="de" %}}”
...
“{{% bible val="An jenem Tag werden sich viele Heidenvölker dem HERRN anschließen, und sie sollen mein Volk sein; und ich werde in deiner Mitte Wohnung machen, und du wirst erkennen, dass mich der HERR der Heerscharen zu dir gesandt hat." link="zec:2,15" lang="de" %}}”
...
- {{% bible val="Ägypter" link="exo:12,38" lang="de" %}} haben {{% bible val="die gleichen Rechte" link="exo:12,48-51" lang="de" %}}
- {{% bible val="Rahab" link="jos:6,25" lang="de" %}} ist {{% bible val="eingeschlossen" link="mat:1,5" lang="de" %}}
- {{% bible val="Rut" link="rut:1,16" lang="de" %}}, die {{% bible val="Moabiterin" link="rut:1,1-4" lang="de" %}}, ist eingeschlossen und wird Vorfahrin von {{% bible val="David" link="rut:4,10-16" lang="de" %}} und {{% bible val="Jesus" link="mat:1,5" lang="de" %}}.

Diese Szenen beschreiben Nichtjuden, die eingeheiratet haben. Die Tatsache, dass sie eigenes Land bekommen haben, macht sie zu Israeliten, denn {{% bible val="nur Israeliten können Land bekommen" link="lev:25,23" lang="de" %}}.

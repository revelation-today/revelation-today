...
<a name="99a2"></a>
Am Ort der vollkommenen Anbetung taucht {{% bible val="ein Buch mit sieben Siegeln auf" link="https://www.bibleserver.com/SLT/Offenbarung5%2C1" %}}, das alle Aufmerksamkeit auf sich zieht. Aber was ist ein solches Buch?
...
Bei all dem sind die Heiligen nicht ausgenommen, wie wir im{{% bible val=" fünften Siegel sehen, denn sie leiden und fragen, wie lange das noch dauern soll. Ihre Bitte wird erhört (sie erhalten weiße Gewänder). Dieser Abschnitt begleitet uns durch das ganze Buch: Die Rechtfertigung der Heiligen und die Erhörung ihres Gebetes." link="https://www.bibleserver.com/SLT/Offenbarung6%2C9-11" %}}

Die wesentliche {{% bible val="Antwort ist das Endgericht" link="https://www.bibleserver.com/SLT/Offenbarung6%2C12-17" %}}. Das ist der {{% int_link val="Tag des Herrn" link="/background/israel/expl/the-day-of-the-lord" %}}, an dem jeder Rechenschaft ablegen muss und niemand sich davor verstecken kann.

Nach einem Einschub über die {{% int_link val="144.000" link="/content/army/expl/the-144000" %}} wird das siebente Siegel geöffnet. Es zeigt eine halbe Stunde der Stille. Das Schweigen hat in der Bibel eine eigene Bedeutung. In der jüdischen Literatur gibt es eine starke Verbindung zwischen der Zeit der Stille im Himmel und der Zeit, in der Gott die Gebete der Heiligen hört. Dies greift die Idee des{{% bible val=" fünften Siegels auf und stellt sie in den Mittelpunkt" link="https://www.bibleserver.com/SLT/Offenbarung6%2C9-11" %}}. Auch wenn das Gebet nur hier und {{% bible val="an einer anderen Stelle " link="https://www.bibleserver.com/SLT/Offenbarung8%2C2-5" %}}erwähnt wird, verbindet es die Siegel mit den Posaunen und spielt auch dort eine zentrale Rolle.

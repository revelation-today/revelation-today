...
Sie singen ein neues Lied, dessen Kontext dem von {{% bible val="Kapitel 5" link="https://www.bibleserver.com/SLT/Offenbarung5%2C9-10" %}} ähnelt, wo beschrieben wird, wie die Anbetung des Lammes auf die ganze Schöpfung ausgedehnt wird.
...
- Keine Lüge wurde in ihrem Mund gefunden: Sie sind treue Zeugen wie {{% bible val="Jesus, der treu blieb, wenn er in Anfechtung war" link="https://www.bibleserver.com/SLT/1.Petrus2%2C22" %}}.
...
<a name="45b1"></a>
Nach ihm kommen vier Wesen: drei Engel und einer, der aussieht wie der Menschensohn, die die Weizen- und Traubenernte einbringen. Aber was bedeutet das? Sind beide Gerichtshandlungen? Zunächst einmal haben beide ihren Ursprung in {{% bible val="Joel" link="https://www.bibleserver.com/SLT/Joel3%2C5" %}}.

In Joel ist beides Gericht, und die Weinpresse in der Offenbarung wird auch die “{{% bible val="Weinpresse des Zornes Gottes" link="https://www.bibleserver.com/SLT/Offenbarung14%2C19" %}}” genannt, ein {{% bible val="Hinweis auf den Tag der Rache des Herrn" link="https://www.bibleserver.com/SLT/Jesaja63%2C1-6" %}}. Das stimmt mit dem {{% bible val="Gericht über Babel einige Verse vorher" link="https://www.bibleserver.com/SLT/Offenbarung14%2C10" %}} überein.

Bei der Weizenernte gibt es jedoch einige wesentliche Unterschiede:

- Die 144.000 sind die Erstlingsgaben, die {{% bible val="normalerweise vom Getreide genommen werden" link="https://www.bibleserver.com/SLT/3.Mose23%2C9-14" %}} (mit einem Lammopfer). Die Erstlingsfrucht war ein {{% bible val="Unterpfand für die gesamte Ernte" link="https://www.bibleserver.com/SLT/R%C3%B6mer11%2C16" %}}, so die 144.000 die von allen Nationen erkauft wurden, die Erstlingsgabe der Nationen. Eine {{% bible val="Erstlingsgabe kann auch von den Trauben" link="https://www.bibleserver.com/SLT/2.Mose22%2C29" %}} kommen, aber das wäre eine merkwürdige Interpretation (Märtyrer als Erstlingsgabe der Rache Gottes?)
- Während die Weinpresse das Sammeln UND das Treten der Presse beinhaltet, wird beim Weizen NUR das Ernten berichtet. Beim Getreide folgt nachher normalerweise das {{% bible val="Dreschen" link="https://www.bibleserver.com/SLT/Jeremia51%2C33" %}}, {{% bible val="Verbrennen" link="https://www.bibleserver.com/SLT/Matth%C3%A4us3%2C12" %}} oder {{% bible val="Verstreuen" link="https://www.bibleserver.com/SLT/Psalm1%2C4" %}} der Spreu, während die {{% bible val="Ernte ohne dies ein Zeichen dafür ist, dass Menschen in Gottes Reich kommen" link="https://www.bibleserver.com/SLT/Markus4%2C29" %}}.
- Die Weizenernte ist eingebracht von “{{% bible val="einem, auf einer Wolke sitzend, der wie ein Menschensohn aussieht und eine Krone auf dem Kopf hat" link="https://www.bibleserver.com/SLT/Offenbarung14%2C14" %}}”. Dies ist ein Bezug auf {{% bible val="Daniel, wo beschrieben wird, wie der Menschensohn ein ewiges Königreich erhält und alle Nationen ihn anbeten" link="https://www.bibleserver.com/SLT/Daniel7%2C13-14" %}}.
...
{{% bible val="Das Lied des Mose beschreibt die Taten Gottes am Roten Meer" link="https://www.bibleserver.com/SLT/2.Mose15%2C1-19" %}}. Aber die Worte sind ganz anders als das, was Mose singt.

Das Thema des Auszuges wird wieder in {{% bible val="Jesaja " link="https://www.bibleserver.com/SLT/Jesaja11%2C15-16" %}}aufgegriffen und als {{% bible val="neuer Auszug" link="https://www.bibleserver.com/SLT/Jesaja12" %}} in zwei Liedern in Jesaja beschrieben, die {{% bible val="dort" link="https://www.bibleserver.com/SLT/Jesaja12%2C4" %}} auch auf {{% bible val="Psalm 105" link="https://www.bibleserver.com/SLT/Psalm105%2C1" %}} (der ebenfalls vom Auszug berichtet) Bezug nehmen. Die Aussage in dieser Kette ist, dass die Nationen durch Gottes Handeln am Roten Meer beeinflusst werden.

Wenn wir Vers 11 im Lied des Mose betrachten, sehen wir die Verbindung zu {{% bible val="Jeremia" link="https://www.bibleserver.com/SLT/Jeremia10%2C6-7" %}}, Psalm {{% bible val="86" link="https://www.bibleserver.com/SLT/Psalm86%2C8-10" %}} und Psalm {{% bible val="98" link="https://www.bibleserver.com/SLT/Psalm98%2C1-2" %}}.

...
|----------|----------------|
| {{% bible val="Das erste Tier ist wie ein Löwe" link="https://www.bibleserver.com/SLT/Daniel7%2C4" %}} | {{% bible val="Maul eines Löwen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C2" %}} |
| {{% bible val="Das zweite Tier ist wie ein Bär" link="https://www.bibleserver.com/SLT/Daniel7%2C5" %}} | {{% bible val="Füße wie Bär" link="https://www.bibleserver.com/SLT/Offenbarung13%2C2" %}} |
| {{% bible val="Das dritte Tier ist wie ein Leopard" link="https://www.bibleserver.com/SLT/Daniel7%2C6" %}} | {{% bible val="Tier wie ein Leopard" link="https://www.bibleserver.com/SLT/Offenbarung13%2C2" %}} |
| {{% bible val="Das vierte Tier hat 10 Hörner" link="https://www.bibleserver.com/SLT/Daniel7%2C7" %}} | {{% bible val="es hat 10 Hörner" link="https://www.bibleserver.com/SLT/Offenbarung13%2C1" %}} |
| {{% bible val="Das dritte Tier hat 4 Köpfe, die andere jeweils einen" link="https://www.bibleserver.com/SLT/Daniel7%2C6" %}} | {{% bible val="hat 7 Köpfe" link="https://www.bibleserver.com/SLT/Offenbarung13%2C1" %}} |
| {{% bible val="Das Horn spricht große Dinge" link="https://www.bibleserver.com/SLT/Daniel7%2C8" %}} </br> {{% bible val="spricht gegen den Höchsten" link="https://www.bibleserver.com/SLT/Daniel7%2C25" %}} | {{% bible val="Tier lästert Gott" link="https://www.bibleserver.com/SLT/Offenbarung13%2C6" %}} |
| {{% bible val="Die 10 Hörner sind 10 Könige" link="https://www.bibleserver.com/SLT/Daniel7%2C24" %}} | {{% bible val="10 Kronen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C1" %}} |
...
|-------|-------------|--------------|
| Ursprung | {{% bible val="Aus dem Meer" link="https://www.bibleserver.com/SLT/Offenbarung13%2C1" %}} | {{% bible val="Aus der Erde" link="https://www.bibleserver.com/SLT/Offenbarung13%2C11" %}} |
| Identität (mit Daniel) | {{% bible val="Tier mit sieben Hörnern" link="https://www.bibleserver.com/SLT/Offenbarung13%2C1" %}} -> Fortbestand und Macht der Reiche | {{% bible val="Tier mit zwei Hörnern wie Lamm/Menschensohn" link="https://www.bibleserver.com/SLT/Offenbarung13%2C11" %}} |
| Macht | {{% bible val="Drache gibt Macht und Thron" link="https://www.bibleserver.com/SLT/Offenbarung13%2C2" %}} | {{% bible val="herrscht in der Macht des ersten Tieres" link="https://www.bibleserver.com/SLT/Offenbarung13%2C12" %}} |
| Zeichen und Anbetung | {{% bible val="Tödliche Wunde ist geheilt" link="https://www.bibleserver.com/SLT/Offenbarung13%2C3" %}} </br> {{% bible val="Die ganze Erde ist erstaunt" link="https://www.bibleserver.com/SLT/Offenbarung13%2C3" %}}
{{% bible val="Betet den Drachen an, der dem Tier die Macht" link="https://www.bibleserver.com/SLT/Offenbarung13%2C4" %}} <span style="color:green;"></span> | {{% bible val="Zwingt alle, das erste Tier anzubeten, dessen Wunde geheilt wurde" link="https://www.bibleserver.com/SLT/Offenbarung13%2C12" %}}. </br> {{% bible val="Tut große Zeichen, lässt Feuer vom Himmel fallen, täuscht durch Zeichen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C13-14" %}} </br> {{% bible val="Erhält die Macht des ersten Tieres" link="https://www.bibleserver.com/SLT/Offenbarung13%2C14" %}}. |
| Prahlerei | {{% bible val="Wer ist wie das Tier (stark wie es)" link="https://www.bibleserver.com/SLT/Offenbarung13%2C4" %}} </br> {{% bible val="große Lästerungen gegen Gott und sein Volk" link="https://www.bibleserver.com/SLT/Offenbarung13%2C5-6" %}}. | {{% bible val="Machtbild des Tieres" link="https://www.bibleserver.com/SLT/Offenbarung13%2C14" %}} (der Mensch ist nach dem Bilde Gottes geschaffen -&gt; der Mensch ist Stellvertreter Gottes)</br> {{% bible val="Kann Leben geben, damit das Tier sprechen kann" link="https://www.bibleserver.com/SLT/Offenbarung13%2C14-15" %}} <span style="color:green;">aber nur Gott kann Leben geben</span>.  |
|Überwindet Heilige | {{% bible val="Kämpft gegen Heilige und besiegt sie" link="https://www.bibleserver.com/SLT/Offenbarung13%2C7" %}}. </br> {{% bible val="Hat Macht über Stämme, Sprachen und Nationen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C7" %}} </br> {{% bible val="Alle auf Erden beten das Tier an, die nicht im Buch des Lebens geschrieben stehen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C8" %}}.| {{% bible val="Tötet alle, die das Bild nicht anbeten" link="https://www.bibleserver.com/SLT/Offenbarung13%2C15" %}}.</br> {{% bible val="Macht Zeichen für alle " link="https://www.bibleserver.com/SLT/Offenbarung13%2C16" %}} </br> {{% bible val="Niemand kann kaufen oder verkaufen, es sei denn, er hat das Zeichen des Tieres" link="https://www.bibleserver.com/SLT/Offenbarung13%2C17" %}}. |
| Wer Ohren hat, der höre!](https://www.bibleserver.com/SLT/Offenbarung13%2C9)</br> {{% bible val="Hier ist die Geduld und der Glaube der Heiligen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C10" %}}. | {{% bible val="Hier ist Weisheit" link="https://www.bibleserver.com/SLT/Offenbarung13%2C18" %}}</br> {{% bible val="Wenn jemand Verstand hat: Zählt" link="https://www.bibleserver.com/SLT/Offenbarung13%2C18" %}} |
...
- durch Gewalt und Einschüchterung ({{% bible val="besiegt die Heiligen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C7" %}}, {{% bible val="vernichtet jeden Widerstand" link="https://www.bibleserver.com/SLT/Offenbarung13%2C10" %}} oder {{% bible val="Menschen, die nicht folgen" link="https://www.bibleserver.com/SLT/Offenbarung13%2C15" %}}),

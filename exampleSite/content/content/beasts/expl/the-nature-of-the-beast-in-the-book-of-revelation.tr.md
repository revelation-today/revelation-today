...
Ancak ilk görünüm, ilk canavarın {{% bible val="Daniel’deki dört krallığın" link="https://www.bibleserver.com/TR/Daniel7%3A1-8" %}} tümünü temsil ettiği gibi görünmez:

İlk canavar ve Daniel'deki canavarlar

| Daniel 7 | Vahiy 13 |
|----------|----------|
| {{% bible val="İlk canavar aslan gibidir" link="https://www.bibleserver.com/TR/Daniel7%2C4" %}} | {{% bible val="Bir aslanın ağzı" link="https://www.bibleserver.com/TR/Vahiy13%2C2" %}} |
| {{% bible val="İkinci hayvan ayı gibidir" link="https://www.bibleserver.com/TR/Daniel7%2C5" %}} | {{% bible val="Ayı gibi ayak" link="https://www.bibleserver.com/TR/Vahiy13%2C2" %}} |
| {{% bible val="Üçüncü hayvan bir leopar gibidir" link="https://www.bibleserver.com/TR/Daniel7%2C6" %}} | {{% bible val="Leopar gibi bir hayvan" link="https://www.bibleserver.com/TR/Vahiy13%2C2" %}} |
| {{% bible val="Dördüncü hayvanın 10 boynuzu vardır" link="https://www.bibleserver.com/TR/Daniel7%2C7" %}} | {{% bible val="10 boynuzu var" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} |
| {{% bible val="Üçüncü hayvanın 4, diğerlerinin birer başı vardır" link="https://www.bibleserver.com/TR/Daniel7%2C6" %}} | {{% bible val="7 kafası var" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} |
| {{% bible val="Boynuz büyük şeyler söylüyor" link="https://www.bibleserver.com/TR/Daniel7%2C8" %}} </br> {{% bible val="En Yüce Olan'a karşı konuşuyor" link="https://www.bibleserver.com/TR/Daniel7%2C25" %}} | {{% bible val="Hayvan Tanrı'ya küfrediyor" link="https://www.bibleserver.com/TR/Vahiy13%2C6" %}} |
| {{% bible val="10 boynuz 10 kraldır" link="https://www.bibleserver.com/TR/Daniel7%2C24" %}} | {{% bible val="10 kron" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} |
...
|-------|-----------|---------------|
| Kökeni | {{% bible val="Denizden" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} | {{% bible val="Topraktan" link="https://www.bibleserver.com/TR/Vahiy13%2C11" %}} |
| Kimlik (Daniel ile) | {{% bible val="Yedi boynuzlu hayvan" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} -> alemlerin devamı ve gücü | {{% bible val="Kuzu gibi iki boynuzlu hayvan/insanoğlu" link="https://www.bibleserver.com/TR/Vahiy13%2C11" %}} |
| güç | {{% bible val="Ejderha güç ve taht verir" link="https://www.bibleserver.com/TR/Vahiy13%2C2" %}} | {{% bible val="İlk canavarın gücüne hükmeder" link="https://www.bibleserver.com/TR/Vahiy13%2C12" %}} |
| İşaretler ve ibadet | {{% bible val="Ölümcül yara iyileşir" link="https://www.bibleserver.com/TR/Vahiy13%2C3" %}} </br> {{% bible val="Tüm dünya hayrete düşer" link="https://www.bibleserver.com/TR/Vahiy13%2C3" %}}
Canavara <span style="color:green;"></span> {{% bible val="Güç veren ejderhaya tapınır" link="https://www.bibleserver.com/TR/Vahiy13%2C4" %}} | {{% bible val="Herkesi yarası iyileştirilen ilk canavara tapınmaya zorlar" link="https://www.bibleserver.com/TR/Vahiy13%2C12" %}}. </br> {{% bible val="Büyük işaretler yapar, gökten ateş yağdırır, işaretlerle kandırır" link="https://www.bibleserver.com/TR/Vahiy13%2C13-14" %}} </br> {{% bible val="İlk canavarın gücünü alır" link="https://www.bibleserver.com/TR/Vahiy13%2C14" %}}. |
| Övünme | {{% bible val="Canavar gibi olan (onun gibi güçlü olan)" link="https://www.bibleserver.com/TR/Vahiy13%2C4" %}} </br> {{% bible val="Tanrı'ya ve halkına karşı büyük küfürler" link="https://www.bibleserver.com/TR/Vahiy13%2C5-6" %}}. | {{% bible val="Canavarın güç görüntüsü" link="https://www.bibleserver.com/TR/Vahiy13%2C14" %}} (insan Tanrı'nın suretinde yaratılmıştır -&gt; insan Tanrı'nın temsilcisidir)</br> {{% bible val="Can verebilir, böylece hayvan konuşabilir" link="https://www.bibleserver.com/TR/Vahiy13%2C14-15" %}} <span style="color:green;">ancak yalnızca Tanrı can verebilir</span>.  |
| Azizlerin üstesinden gelir] {{% bible val="Azizlerle savaşır ve onları yener" link="https://www.bibleserver.com/TR/Vahiy13%2C7" %}}. </br> {{% bible val="Kabileler, diller ve uluslar üzerinde gücü vardır" link="https://www.bibleserver.com/TR/Vahiy13%2C7" %}} </br> {{% bible val="Yeryüzünde yaşam kitabında yazılı olmayan herkes canavara tapar" link="https://www.bibleserver.com/TR/Vahiy13%2C8" %}}.| {{% bible val="Surete tapmayan herkesi öldürün" link="https://www.bibleserver.com/TR/Vahiy13%2C15" %}}.</br> {{% bible val="Herkese işaretler yapın" link="https://www.bibleserver.com/TR/Vahiy13%2C16" %}} </br> {{% bible val="Canavarın işaretine sahip olmayan hiç kimse alıp satamaz" link="https://www.bibleserver.com/TR/Vahiy13%2C17" %}}. |
| Dikkat edin, {{% bible val="Kulağı olan varsa dinlesin!" link="https://www.bibleserver.com/TR/Vahiy13%2C9" %}}</br>{{% bible val="İşte azizlerin sabrı ve imanı" link="https://www.bibleserver.com/TR/Vahiy13%2C10" %}}. | {{% bible val="İşte bilgelik" link="https://www.bibleserver.com/TR/Vahiy13%2C18" %}}</br> {{% bible val="Anlayışı olan varsa: saysın" link="https://www.bibleserver.com/TR/Vahiy13%2C18" %}} |

...
{{% bible val="Chapter 8" link="rev:8" lang="NIV" %}} and {{% bible val="9" link="rev:9" lang="NIV" %}}.
...
She is protected ({{% bible val="by the seal" link="rev:7,1-4" lang="NIV" %}}) from the {{% bible val="fifth trumpet" link="rev:9,4-6" lang="NIV" %}} - they will not loose hope while endurung all the trouble and even loosing their live. But enduring all the loss of the same securites and even their lives make this a great testimony to let people see what are real securities.

...
Aber auch hier gibt es eine Überraschung bis in {{% int_link val="Kapitel 5" link="/content/seals/expl/the-book-with-the-seven-seals" %}}, wo {{% bible val="der Löwe von Judas als das Lamm identifiziert wird, das geschlachtet ist" link="rev:5,6" lang="SLT" %}}. Hier haben wir genau dasselbe: {{% bible val="Die 144.000, die als Armee gezählt werden, von der Johannes hört" link="rev:7,4" lang="SLT" %}}, sind die {{% bible val="unzählbare Schar der Anbeter Gottes aus allen Nationen, die Johannes sieht" link="rev:7,9" lang="SLT" %}}.

Auch hier gibt es eine Verbindung zum fünften Siegel, wo die Seelen unter dem Altar rufen und weiße Gewänder erhalten, wie diese Personen hier. Es scheinen dieselben Menschen zu sein: Sie kommen aus der {{% int_link val="Großen Trübsal" link="/content/army/expl/the-end-time-and-the-great-tribulation" %}} und {{% bible val="werden nun von Gott getröstet" link="rev:7,15-17" lang="SLT" %}}. Sie leben im “bereits und noch nicht”. Wir werden uns diese Gruppe genauer ansehen, wenn wir sie in Kapitel 14 wieder treffen.

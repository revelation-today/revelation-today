...
Der {{% bible val="nächste Vers" link="rev:1,2" lang="de" %}} versträrkt dies, indem er vom Zeugnis Jesu spricht. Wie wir sehen werden, ist {{% int_link val="dies eines der zentralen Themen des ganzen Buches" link="/topics/power/short/the-power-of-testimony" %}}. Jesus redet nicht nur darüber, er lebt sein Zeugnis, und so sollten wir es auch tun.

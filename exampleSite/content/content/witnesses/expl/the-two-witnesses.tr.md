...
- {{% bible val="bireysel yasın" link="https://www.bibleserver.com/TR/Yarat%C4%B1l%C4%B1%C5%9F37%3A34" %}} veya {{% bible val="ulusal sıkıntının" link="https://www.bibleserver.com/TR/A%C4%9F%C4%B1tlar2%3A10" %}} işareti
...
|------|------------|---------------|
| Köken | <span style="color:red;">{{% bible val="Denizden" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}}</span> | <span style="color:red;">{{% bible val="Topraktan" link="https://www.bibleserver.com/TR/Vahiy13%2C11" %}}</span> |
| Kimlik (Daniel ile) | Yedi <span style="color:green;">boynuzlu canavar</span> {{% bible val="Vah.13/1" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}} -> Krallıkların devamı ve gücü | Kuzu/insanoğlu gibi iki <span style="color:green;">boynuzlu canavar</span> {{% bible val="Vah.13/11" link="https://www.bibleserver.com/TR/Vahiy13%2C11" %}} |
| Güç | <span style="color:green;">ejderha</span> güç ve taht verir {{% bible val="Vah.13/2" link="https://www.bibleserver.com/TR/Vahiy13%2C2" %}} | <span style="color:green;">ilk canavarın</span> gücüyle hüküm sürer {{% bible val="Vah.13/12" link="https://www.bibleserver.com/TR/Vahiy13%2C12" %}} |
| İşaret ve İbadet | <span style="color:green;">{{% bible val="Ölümcül Yara İyileşti" link="https://www.bibleserver.com/TR/Vahiy13%2C3" %}}</span> </br> Tüm Dünya <span style="color:green;">Hayret</span>{{% bible val="Vah.13/3" link="https://www.bibleserver.com/TR/Vahiy13%2C3" %}} </br> <span style="color:green;">Canavara Güç Veren Ejderhaya</span> Tapın</span> {{% bible val="Vah.13/4" link="https://www.bibleserver.com/TR/Vahiy13%2C4" %}} | Herkesi <span style="color:green;">yarası iyileştirilen</span> <span style="color:green;">ilk canavara</span> tapmaya zorlar {{% bible val="Vah.13/12" link="https://www.bibleserver.com/TR/Vahiy13%2C12" %}} </br> <span style="color:green;">büyük işaretler yapar, gökten ateş yağdırır, işaretlerle</span> kandırır {{% bible val="Vah.13/13-14" link="https://www.bibleserver.com/TR/Vahiy13%2C13-14" %}}</br> <span style="color:green;">ilk canavarın</span> gücünü alır {{% bible val="Vah.13/14" link="https://www.bibleserver.com/TR/Vahiy13%2C14" %}} |
| övünme | <span style="color:green;">canavar gibi olan</span> (onun gibi güçlü olan) {{% bible val="Vah.13/4" link="https://www.bibleserver.com/TR/Vahiy13%2C4" %}}</br> <span style="color:green;">{{% bible val="Tanrı'ya ve halkına karşı büyük küfürler" link="https://www.bibleserver.com/TR/Vahiy13%2C5-6" %}}</span> | <span style="color:green;">{{% bible val="canavarın sureti" link="https://www.bibleserver.com/TR/Vahiy13%2C14" %}}</span> (İnsan Tanrı'nın suretinde yaratılmıştır -&gt; İnsan Tanrı'nın temsilcisidir)</br> {{% bible val="Hayvan konuşabilsin diye can verebilir" link="https://www.bibleserver.com/TR/Vahiy13%2C14-15" %}}, <span style="color:green;">ancak yalnızca Tanrı can verebilir</span> |
| <span style="color:green;">Kutsallara karşı savaşır</span> ve onları yener {{% bible val="Vah.13/7" link="https://www.bibleserver.com/TR/Vahiy13%2C7" %}}</br> <span style="color:green;">Kabileler, diller ve uluslar üzerinde güce sahiptir</span>{{% bible val="Vah.13/7" link="https://www.bibleserver.com/TR/Vahiy13%2C7" %}} </br> <span style="color:green;">Yeryüzündeki herkes</span> <span style="color:red;">Hayat Kitabı'nda yazılı olmayan canavara</span> tapar {{% bible val="Vah.13/8" link="https://www.bibleserver.com/TR/Vahiy13%2C8" %}} | <span style="color:green;">{{% bible val="imgeye tapmayan herkesi öldürün" link="https://www.bibleserver.com/TR/Vahiy13%2C15" %}}</span></br> Herkese <span style="color:green;">işaretler yapın</span> {{% bible val="Vah.13/16" link="https://www.bibleserver.com/TR/Vahiy13%2C16" %}} </br> <span style="color:green;">Hiç kimse</span> <span style="color:red;">canavarın işaretine</span> sahip olmadıkça <span style="color:green;">alamaz ya da satamaz</span> {{% bible val="Vah.13/17" link="https://www.bibleserver.com/TR/Vahiy13%2C17" %}} |
| Dikkat | <span style="color:green;">Eğer</span> <span style="color:red;">kulağı olan varsa, dinlesin</span>! {{% bible val="Vah.13/9" link="https://www.bibleserver.com/TR/Vahiy13%2C9" %}}</br> <span style="color:green;">İşte</span> <span style="color:red;">kutsalların sabrı ve imanı</span> {{% bible val="Vah.13/10" link="https://www.bibleserver.com/TR/Vahiy13%2C10" %}} | <span style="color:green;">İşte</span> <span style="color:red;">Bilgelik</span>" {{% bible val="Vah.13/18" link="https://www.bibleserver.com/TR/Vahiy13%2C18" %}}</br><span style="color:green;">Eğer biri</span> <span style="color:red;">anlayışa sahipse: Say</span>! {{% bible val="Vah.13/18" link="https://www.bibleserver.com/TR/Vahiy13%2C18" %}} |
...
Ancak bunun dışında {{% bible val="tanıklar" link="https://www.bibleserver.com/TR/Vahiy11%3A3-13" %}} ve {{% bible val="hayvanlar" link="https://www.bibleserver.com/TR/Vahiy13" %}} çok farklıdır.

| Tema | Hayvanlar | Tanıklar |
|-------|----------|----------|
| Tarafından arandı | <span style="color:red;">{{% bible val="kalıcı kaybeden" link="https://www.bibleserver.com/TR/Vahiy12" %}}</span> olan {{% bible val="ejderha" link="https://www.bibleserver.com/TR/Vahiy12%2C17" %}} tarafından çağrılan | <span style="color:red;">{{% bible val="göklere ve yere" link="https://www.bibleserver.com/TR/Vahiy10%2C2" %}}</span> hükmeden {{% bible val="tanrı" link="https://www.bibleserver.com/TR/Vahiy11%2C3" %}} |
| Kökeni | {{% bible val="denizden" link="https://www.bibleserver.com/TR/Vahiy13%2C1" %}}, {{% bible val="topraktan" link="https://www.bibleserver.com/TR/Vahiy13%2C11" %}} | {{% bible val="çul içinde" link="https://www.bibleserver.com/TR/Vahiy11%2C3" %}} |

...
The story is only two chapters long in the Bible and is worth reading in advance. It is first the {{% bible val="story of keeping the Israelites" link="exo:1" lang="en" %}} small to avoid a second {{% int_link val="Hyksos" link="/bible/exodus/expl/the-story-before-the-exodus" %}} and then the {{% bible val="story of Moses" link="exo:2" lang="en" %}}.

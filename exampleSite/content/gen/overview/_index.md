...
The two witnesses in {{% bible val="chapter 11" link="rev:11" lang="en" %}} follow in Jesus’ footsteps from their calling to their death, resurrection, and ascension. And the turning point was not when they performed signs and wonders, but when they gave their lives (and God confirmed them) and many unbelievers worshiped God.

The church can only be successful if it follows Jesus without compromise.

On the other hand you see the devil in {{% bible val="chapter 13" link="rev:13" lang="en" %}}setting up a counter-trinity that has all the things we think are needed in the church.
...
- Jesus appears as the one who was {{% bible val="pierced" link="rev:1,7" lang="en" %}} just before being introduced {{% bible val="as the Son of Man who will judge the world" link="rev:1,12-16" lang="en" %}}.
- The throne room of God mentions elements of grace like the {{% bible val="rainbow" link="rev:4,3" lang="en" %}}.
- The Lion of Judah is actually the {{% bible val="Lamb" link="rev:5,5-6" lang="en" %}} of God
- The {{% bible val="army of the 144.000" link="rev:7,4-8" lang="en" %}} is explained as people who {{% bible val="worship" link="rev:7,9-10" lang="en" %}} God and later as those who follow the lamb and the {{% bible val="faithful" link="rev:14,1-5" lang="en" %}} who come out of the Great Tribulation.
- The victory of the two witnesses is their {{% bible val="death" link="rev:11,7-13" lang="en" %}}.
- The mysterious place of {{% bible val="Armageddon" link="rev:16,14" lang="en" %}} describes the {{% int_link val="defeat of the strong and the victory of the absolute weak" link="/content/bowls/expl/the-key-to-armageddon" %}}.
- The harlot is {{% bible val="destroyed by the beast" link="rev:17,16" lang="en" %}} on which she {{% bible val="sat" link="rev:17,3" lang="en" %}}.
- Jesus comes and {{% bible val="kills the armies with the sword of his mouth" link="rev:19,21" lang="en" %}}.
...
<a name="dd7a"></a>
Now, if you read carefully, you will see that this word does not appear in the book, but in the {{% bible val="epistle of John" link="1jn:2,18" lang="en" %}} (and there he talks about many of them in his day). But the principle is shown in the book. Anti can mean not only “against,” but also “instead. And there are many places where he tries to be instead of Jesus.

He appears {{% bible val="in the first seal as a savior" link="rev:6,1-2" lang="en" %}}, the imitates the {{% bible val="Trinity of God" link="rev:13" lang="en" %}} and the harlot is a {{% bible val="perverted image of the Bride of Christ" link="rev:17,1-6" lang="en" %}}.

...
- İsa sadece kısa bir süre önce {{% bible val="delinmiş" link="rev:1,7" lang="TR" %}} olan kişi olarak değil, {{% bible val="dünyayı yargılayan insanoğlu olarak da görünür" link="rev:1,12-16" lang="TR" %}}
- Tanrı’nın taht odası {{% bible val="gökkuşağı" link="rev:4,3" lang="TR" %}} gibi açıkça lütuf unsurundan bahseder
- Yahuda’nın aslanı aslında Tanrı’nın {{% bible val="kuzusudur" link="rev:5,5-6" lang="TR" %}}.
- {{% bible val="144.000 kişilik ordu" link="rev:7,4-8" lang="TR" %}}, Tanrı’ya {{% bible val="ibadet" link="rev:7,9-10" lang="TR" %}} eden insanlar olarak ve daha sonra kuzuyu takip eden ve {{% bible val="sadık" link="rev:14,1-5" lang="TR" %}} olanlar olarak açıklanır.
- i̇ki̇ taniğin zaferi̇ onlarin {{% bible val="ölümüdür" link="rev:11,7-13" lang="TR" %}}
- gizemli yer {{% bible val="Armageddon" link="rev:16,14" lang="TR" %}}, {{% int_link val="güçlülerin yenilgisini ve mutlak zayıfların zaferini anlatır" link="/content/bowls/expl/the-key-to-armageddon" %}}
- fahişe, üzerinde {{% bible val="oturduğu" link="rev:17,3" lang="TR" %}} {{% bible val="canavar tarafından yok edilir" link="rev:17,16" lang="TR" %}}
- İsa gelir ve {{% bible val="ağzının kılıcıyla orduları öldürür" link="rev:19,21" lang="TR" %}}.
...
<a name="0f8f"></a>
Eğer dikkatlice okursanız, bu kelimenin kitapta değil, {{% bible val="Yuhanna’nın mektubunda" link="1jn:2,18" lang="TR" %}} geçtiğini göreceksiniz (ve orada kendi zamanındaki pek çok kişiden bahsediyor). Ancak prensip kitapta gösterilmektedir. Anti sadece “karşı” değil, aynı zamanda “yerine” anlamına da gelebilir. Ve İsa’nın yerine orada olmaya çalıştığı birçok yer vardır.

{{% bible val="İlk mühürde kurtarıcı" link="rev:6,1-2" lang="TR" %}} olarak ortaya çıkar, {{% bible val="Tanrı’nın üçlüsünü" link="rev:13" lang="TR" %}} taklit eder ve fahişe {{% bible val="Mesih’in gelininin sapkın bir görüntüsüdür" link="rev:17,1-6" lang="TR" %}}.
...
<a name="5330"></a>
Kilisenin belirleyici unsurunun mucizeler, kötülük üzerinde güç ve siyasi/finansal nüfuz olduğunu düşünüyorsanız, kolayca yanıltılabilirsiniz. {{% bible val="Bölüm 13" link="rev:13" lang="TR" %}} bunların aynı zamanda şeytanın da sahip olduğu şeyler olduğunu gösterir. Aslında bu iki tanığın da sahip olduğu şeydir ama herhangi bir değişiklik getirmez, sadece diğer insanları öfkelendirir. Çünkü bununla birlikte genellikle gözdağı verme, korku yaratma ve manipülasyon gelir ki bunu haçlı seferlerinde, engizisyonda ve bugünlerde bile kilisedeki istismarcı ilişkilerde gördük.
...
- Tanıklık: Farkındalıkla okursanız, bunun her yerde olduğunu göreceksiniz. Ölümle sonuçlansa bile Mesih’i yaşamak ve taklit etmekle ilgilidir. Bu, 11. bölümdeki durumu değiştiren şeydi. Şeytan İsa’nın kanı ve 12. bölümdeki {{% bible val="tanıklık" link="rev:12,11" lang="TR" %}} sayesinde yenilgiye uğratıldı. Kendiniz okuyun ve hangi durumlarda ne kadar sık tanıklık ya da tanıklık bulduğunuza bakın.

...
### A grand disaster ({{% bible val="Chapter 2–3" link="rev:2" lang="en" %}})
...
### Guidance is ahead ({{% bible val="Chapter 4–5" link="rev:4" lang="en" %}})
...
### Evil awakes — join the army ({{% bible val="Chapter 6–7" link="rev:6" lang="en" %}})
...
### The first strike ({{% bible val="Chapter 8–9" link="rev:8" lang="en" %}})
...
### The big clash ({{% bible val="Chapter 11–13" link="rev:11" lang="en" %}})
...
### Victory ({{% bible val="Chapter 14–16" link="rev:14" lang="en" %}})
...
### The ultimate battle ({{% bible val="Chapter 17–19" link="rev:17" lang="en" %}})
...
### A new beginning ({{% bible val="Chapter 20–22" link="rev:20" lang="en" %}})

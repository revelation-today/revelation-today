...
### A grand disaster ({{% bible val="Chapter 2–3" link="rev:2" lang="NIV" %}})
...
### Guidance is ahead ({{% bible val="Chapter 4–5" link="rev:4" lang="NIV" %}})
...
### Evil awakes — join the army ({{% bible val="Chapter 6–7" link="rev:6" lang="NIV" %}})
...
### The first strike ({{% bible val="Chapter 8–9" link="rev:8" lang="NIV" %}})
...
### Reality check ({{% bible val="Chapter 10" link="rev:10" lang="NIV" %}})
...
### The big clash ({{% bible val="Chapter 11–13" link="rev:11" lang="NIV" %}})
...
### Victory ({{% bible val="Chapter 14–16" link="rev:14" lang="NIV" %}})
...
### The ultimate battle ({{% bible val="Chapter 17–19" link="rev:17" lang="NIV" %}})
...
### A new beginning ({{% bible val="Chapter 20–22" link="rev:20" lang="NIV" %}})

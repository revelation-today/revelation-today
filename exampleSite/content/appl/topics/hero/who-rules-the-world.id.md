---
title: "Siapa yang Memerintah Dunia"
themes: ["Pahlawan"]
...
<a name="2c23"></a>
Ketika Yesus mati di kayu salib, Iblis dikalahkan. Itulah yang dikatakan kepada kita, tetapi tampaknya tidak ada yang berubah. {{% bible val="Mungkin bahkan menjadi lebih buruk" link="rev:12,12" lang="ind" %}}.

- Ajaran Yesus terdengar seperti cita-cita yang tidak mungkin dicapai.
- Kerajaan-kerajaan jahat masih tetap berkuasa meskipun ada {{% int_link val="nubuat-nubuat" link="/expl/bible/daniel/the-four-kingdoms-in-daniel" %}}.
...
Tetapi itu tidak terjadi ketika Yesus datang. Ia membuat beberapa pernyataan dalam {{% bible val="Markus" link="mrk:10,29-30" lang="ind" %}}, {{% bible val="Lukas" link="luk:20,34-35" lang="ind" %}}, dan {{% bible val="surat-surat" link="eph:1,21" lang="ind" %}} tentang zaman sekarang (yang jahat) dan zaman yang akan datang (yang baik).

Tetapi {{% bible val="kuasa zaman yang akan datang sudah hadir sekarang" link="heb:6,5" lang="ind" %}}, {{% bible val="tersedia dalam Roh Kudus" link="2co:1,22" lang="ind" %}}, dan {{% bible val="dapat dialami dalam kehidupan bersama Roh Kudus" link="rom:8,14-39" lang="ind" %}}. {{% bible val="Kerajaan yang akan datang itu tersembunyi dan membuat kita tampak menyedihkan" link="2co:4,3-18" lang="ind" %}}.
...
<a name="25a9"></a>
Ketegangan ini terlihat dalam Kitab Wahyu melalui penggambaran yang berlangsung bersamaan tentang {{% bible val="kita sebagai raja-raja" link="rev:1,6" lang="ind" %}} dan {{% int_link val="otoritas penuh kedua saksi" link="/expl/content/witnesses/the-two-witnesses" %}} di satu sisi, dan {{% int_link val="kekuasaan sang binatang yang tak tertandingi di sisi lain, yang bahkan mengalahkan gereja sendiri" link="/expl/content/beasts/the-nature-of-the-beast-in-the-book-of-revelation" %}}.

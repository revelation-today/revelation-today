...
<a name="a5c1"></a>
Bu konu tüm kitap boyunca devam eder ve sadece {{% int_link val="ibadetle" link="/appl/topics/power/worship" %}} bastırılan kilit bir konudur.
...
Tanık olmanın anahtarı, kitapta daha da baskın bir konu olan ibadettir. İbadet sadakat demektir. {{% int_link val="Ölüme kadar sadakat" link="/appl/topics/power/worship" %}}. Tanık kelimesinin Yunancası şehittir, çünkü kilisenin ilk yıllarında tanıklıkları o kadar ileri gitmiştir ki, tanıklıkları uğruna hayatlarını bırakmaya istekli ve muktedir olmuşlardır. Ve ölümden çok korkmalıyız, çünkü vaat şudur: {{% bible val="Bu gerçekleşmeden önce kaderimizi yerine getireceğiz" link="rev:11,7" lang="tr" %}}.

...
[Start the story →]({{< relref "story/prosperity-gospel/tour" >}})

**Production notes**

This version is meant to be woven into an existing regional or denominational story track at the sections it touches most directly - the seals/army, beasts, and harlot chapters especially - rather than used on its own as a freestanding critique of any teaching, ministry, or teacher. Presented in isolation, this material can read as an attack on a movement; read inside the larger sweep of Revelation, it reads instead as what it actually is - the book confronting a temptation it has named since chapter 6, addressed with the same respect the rest of the story extends to every audience it speaks to.

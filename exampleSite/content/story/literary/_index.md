...
[Start the story →]({{< relref "story/literary/tour" >}})

**Production notes**
- This is not a simplified companion to the general story — it is denser, more compressed, more allusive, written for readers already fluent in the Old Testament texts Revelation leans on hardest.
- Every echo lives in the imagery and word choice themselves, never flagged or explained; the story still reads as a complete, self-sufficient narrative for anyone who doesn't catch them.
- Pairs naturally with the site's `expl` track for readers who then want the footnotes and argument behind what they half-recognized.

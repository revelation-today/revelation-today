...
- In {{% bible val="chapter 13" link="rev:13" lang="en" %}} we see also a {{% int_link val="trinity" link="/quick/content/beasts/quick" %}} with with the two beasts and Satan as the dragon in the background
- Also {{% bible val="chapter 17" link="rev:17" lang="en" %}} with the {{% int_link val="harlot and the beast" link="/quick/content/harlot/quick" %}} (first beast of chapter 13) reflects this topic. Here Satan is even more hidden.
